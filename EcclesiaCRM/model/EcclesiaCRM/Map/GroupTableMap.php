...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.GroupTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Group';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Group');
    ...
    {
        $this->addRelation('ListOption', '\\EcclesiaCRM\\ListOption', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':grp_RoleListID',
    1 => ':lst_ID',
  ...
  array (
    ...
    1 => ':grp_ID',
        ...
        $this->addRelation('EventTypes', '\\EcclesiaCRM\\EventTypes', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':type_grpid',
    1 => ':grp_ID',
  ),
), null, null, 'EventTypess', false);
        $this->addRelation('Event', '\\EcclesiaCRM\\Event', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':event_grpid',
    1 => ':grp_ID',
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to group_grp     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Group) { // it's a model object
