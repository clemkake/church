...
class PersonVolunteerOpportunityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PersonVolunteerOpportunityTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\PersonVolunteerOpportunity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.PersonVolunteerOpportunity';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\PersonVolunteerOpportunity');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('p2vo_ID', 'Id', 'SMALLINT', true, 9, null);
        $this->addForeignKey('p2vo_per_ID', 'PersonId', 'SMALLINT', 'person_per', 'per_ID', false, 9, null);
        $this->addForeignKey('p2vo_vol_ID', 'VolunteerOpportunityId', 'SMALLINT', 'volunteeropportunity_vol', 'vol_ID', false, 9, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':per_ID',
        ...
        $this->addRelation('VolunteerOpportunity', '\\EcclesiaCRM\\VolunteerOpportunity', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':p2vo_vol_ID',
    1 => ':vol_ID',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\PersonVolunteerOpportunity) { // it's a model object
