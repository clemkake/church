...
class EventAttendTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EventAttendTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EventAttend';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EventAttend';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EventAttend');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EventAttend) { // it's a model object
