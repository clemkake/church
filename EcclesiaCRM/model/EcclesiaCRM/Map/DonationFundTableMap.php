...
class DonationFundTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.DonationFundTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\DonationFund';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.DonationFund';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\DonationFund');
  ...
  array (
    ...
    1 => ':fun_ID',
        ...
        $this->addRelation('Deposit', '\\EcclesiaCRM\\Deposit', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':dep_Fund',
    1 => ':fun_ID',
  ),
), null, null, 'Deposits', false);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to donationfund_fun     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\DonationFund) { // it's a model object
