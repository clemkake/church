...
class PledgeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PledgeTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Pledge';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Pledge';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Pledge');
        ...
        $this->addForeignKey('plg_aut_ID', 'AutId', 'SMALLINT', 'autopayment_aut', 'aut_ID', true, 9, 0);
    ...
    {
        $this->addRelation('Deposit', '\\EcclesiaCRM\\Deposit', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':plg_depID',
    1 => ':dep_ID',
  ...
  array (
    ...
    1 => ':fam_ID',
        ...
        $this->addRelation('AutoPayment', '\\EcclesiaCRM\\AutoPayment', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':plg_aut_ID',
    1 => ':aut_ID',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Pledge) { // it's a model object
