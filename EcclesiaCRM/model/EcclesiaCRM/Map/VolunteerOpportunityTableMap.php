...
class VolunteerOpportunityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.VolunteerOpportunityTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\VolunteerOpportunity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.VolunteerOpportunity';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\VolunteerOpportunity');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('vol_ID', 'Id', 'SMALLINT', true, 9, null);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to volunteeropportunity_vol     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\VolunteerOpportunity) { // it's a model object
