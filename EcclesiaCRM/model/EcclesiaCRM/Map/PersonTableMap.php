...
class PersonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PersonTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Person';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Person';
    ...
    /**
     * the column name for the per_FacebookID field
     */
    const COL_PER_FACEBOOKID = 'person_per.per_FacebookID';
     ...
     */
    const COL_PER_DATEDEACTIVATED = 'person_per.per_DateDeactivated';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Person');
        ...
        $this->addColumn('per_Gender', 'Gender', 'TINYINT', true, 1, 0);
        ...
        $this->addColumn('per_FacebookID', 'FacebookID', 'BIGINT', false, 20, null);
        $this->addColumn('per_Twitter', 'Twitter', 'VARCHAR', false, 50, null);
        $this->addColumn('per_LinkedIn', 'LinkedIn', 'VARCHAR', false, 50, null);
        $this->addColumn('per_DateDeactivated', 'DateDeactivated', 'TIMESTAMP', false, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':fam_ID',
        ...
        $this->addRelation('PersonCustom', '\\EcclesiaCRM\\PersonCustom', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':per_ID',
    1 => ':per_ID',
        ...
        $this->addRelation('Note', '\\EcclesiaCRM\\Note', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':nte_per_ID',
    1 => ':per_ID',
        ...
        $this->addRelation('NoteShare', '\\EcclesiaCRM\\NoteShare', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':nte_sh_share_to_person_ID',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'NoteShares', false);
        $this->addRelation('Person2group2roleP2g2r', '\\EcclesiaCRM\\Person2group2roleP2g2r', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':p2g2r_per_ID',
    1 => ':per_ID',
        ...
        $this->addRelation('AutoPayment', '\\EcclesiaCRM\\AutoPayment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':aut_EditedBy',
    1 => ':per_ID',
  ),
), 'SET NULL', null, 'AutoPayments', false);
  ...
  array (
    ...
    1 => ':per_ID',
        ...
        $this->addRelation('Pledge', '\\EcclesiaCRM\\Pledge', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':plg_EditedBy',
    1 => ':per_ID',
        ...
        $this->addRelation('User', '\\EcclesiaCRM\\User', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':usr_per_ID',
    1 => ':per_ID',
        ...
        $this->addRelation('PersonVolunteerOpportunity', '\\EcclesiaCRM\\PersonVolunteerOpportunity', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':p2vo_per_ID',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'PersonVolunteerOpportunities', false);
        $this->addRelation('GroupManagerPerson', '\\EcclesiaCRM\\GroupManagerPerson', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':grp_mgr_per_person_ID',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'GroupManagerpeople', false);
        $this->addRelation('CKEditorTemplates', '\\EcclesiaCRM\\CKEditorTemplates', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':cke_tmp_per_ID',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'CKEditorTemplatess', false);
        $this->addRelation('PastoralCareRelatedByPastorId', '\\EcclesiaCRM\\PastoralCare', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':pst_cr_pastor_id',
    1 => ':per_ID',
  ),
), 'SET NULL', null, 'PastoralCaresRelatedByPastorId', false);
        $this->addRelation('PastoralCareRelatedByPersonId', '\\EcclesiaCRM\\PastoralCare', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':pst_cr_person_id',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'PastoralCaresRelatedByPersonId', false);
        $this->addRelation('MenuLink', '\\EcclesiaCRM\\MenuLink', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':linkPersonId',
    1 => ':per_ID',
  ),
), 'CASCADE', null, 'MenuLinks', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to person_per     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PersonTableMap::COL_PER_FACEBOOKID);
            $criteria->addSelectColumn(PersonTableMap::COL_PER_TWITTER);
            $criteria->addSelectColumn(PersonTableMap::COL_PER_LINKEDIN);
            $criteria->addSelectColumn(PersonTableMap::COL_PER_DATEDEACTIVATED);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.per_FacebookID');
            $criteria->addSelectColumn($alias . '.per_Twitter');
            $criteria->addSelectColumn($alias . '.per_LinkedIn');
            $criteria->addSelectColumn($alias . '.per_DateDeactivated');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Person) { // it's a model object
