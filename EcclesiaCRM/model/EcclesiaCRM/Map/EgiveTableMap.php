...
class EgiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EgiveTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Egive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Egive';
    ...
    /**
     * the column name for the egv_ID field
     */
    const COL_EGV_ID = 'egive_egv.egv_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'EgiveId', 'FamId', 'DateEntered', 'DateLastEdited', 'EnteredBy', 'EditedBy', ),
        self::TYPE_CAMELNAME     => array('id', 'egiveId', 'famId', 'dateEntered', 'dateLastEdited', 'enteredBy', 'editedBy', ),
        self::TYPE_COLNAME       => array(EgiveTableMap::COL_EGV_ID, EgiveTableMap::COL_EGV_EGIVEID, EgiveTableMap::COL_EGV_FAMID, EgiveTableMap::COL_EGV_DATEENTERED, EgiveTableMap::COL_EGV_DATELASTEDITED, EgiveTableMap::COL_EGV_ENTEREDBY, EgiveTableMap::COL_EGV_EDITEDBY, ),
        self::TYPE_FIELDNAME     => array('egv_ID', 'egv_egiveID', 'egv_famID', 'egv_DateEntered', 'egv_DateLastEdited', 'egv_EnteredBy', 'egv_EditedBy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'EgiveId' => 1, 'FamId' => 2, 'DateEntered' => 3, 'DateLastEdited' => 4, 'EnteredBy' => 5, 'EditedBy' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'egiveId' => 1, 'famId' => 2, 'dateEntered' => 3, 'dateLastEdited' => 4, 'enteredBy' => 5, 'editedBy' => 6, ),
        self::TYPE_COLNAME       => array(EgiveTableMap::COL_EGV_ID => 0, EgiveTableMap::COL_EGV_EGIVEID => 1, EgiveTableMap::COL_EGV_FAMID => 2, EgiveTableMap::COL_EGV_DATEENTERED => 3, EgiveTableMap::COL_EGV_DATELASTEDITED => 4, EgiveTableMap::COL_EGV_ENTEREDBY => 5, EgiveTableMap::COL_EGV_EDITEDBY => 6, ),
        self::TYPE_FIELDNAME     => array('egv_ID' => 0, 'egv_egiveID' => 1, 'egv_famID' => 2, 'egv_DateEntered' => 3, 'egv_DateLastEdited' => 4, 'egv_EnteredBy' => 5, 'egv_EditedBy' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Egive');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('egv_ID', 'Id', 'SMALLINT', true, 9, null);
        $this->addColumn('egv_egiveID', 'EgiveId', 'VARCHAR', true, 16, null);
        $this->addForeignKey('egv_famID', 'FamId', 'SMALLINT', 'family_fam', 'fam_ID', true, 9, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EgiveTableMap::COL_EGV_ID);
            ...
            $criteria->addSelectColumn($alias . '.egv_ID');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Egive) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(EgiveTableMap::DATABASE_NAME);
            $criteria->add(EgiveTableMap::COL_EGV_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(EgiveTableMap::COL_EGV_ID) && $criteria->keyContainsValue(EgiveTableMap::COL_EGV_ID) ) {
