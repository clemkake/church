...
class FamilyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.FamilyTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Family';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Family';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Family');
    ...
    {
        $this->addRelation('Person', '\\EcclesiaCRM\\Person', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':per_fam_ID',
    1 => ':fam_ID',
...
), 'CASCADE', null, 'AutoPayments', false);
        $this->addRelation('Egive', '\\EcclesiaCRM\\Egive', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':egv_famID',
    1 => ':fam_ID',
  ),
), 'CASCADE', null, 'Egives', false);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to family_fam     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Family) { // it's a model object
