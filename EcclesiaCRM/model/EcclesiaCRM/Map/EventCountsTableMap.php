...
class EventCountsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EventCountsTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EventCounts';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EventCounts';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EventCounts');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('evtcnt_eventid', 'EvtcntEventid', 'INTEGER' , 'events_event', 'event_id', true, 5, 0);
        $this->addForeignPrimaryKey('evtcnt_countid', 'EvtcntCountid', 'INTEGER' , 'eventcountnames_evctnm', 'evctnm_countid', true, 5, 0);
    ...
    {
        $this->addRelation('EventCountName', '\\EcclesiaCRM\\EventCountName', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':evtcnt_countid',
    1 => ':evctnm_countid',
        ...
        $this->addRelation('Event', '\\EcclesiaCRM\\Event', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':evtcnt_eventid',
    1 => ':event_id',
     ...
     * and findPk*() calls.
     *
     * @param \EcclesiaCRM\EventCounts $obj A \EcclesiaCRM\EventCounts object.
     ...
     *
     * @param mixed $value A \EcclesiaCRM\EventCounts object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \EcclesiaCRM\EventCounts) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \EcclesiaCRM\EventCounts object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EventCounts) { // it's a model object
