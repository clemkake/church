...
class MenuLinkTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.MenuLinkTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\MenuLink';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.MenuLink';
    ...
    /**
     * the column name for the linkPersonId field
     */
    const COL_LINKPERSONID = 'menu_links.linkPersonId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'PersonId', 'Name', 'Uri', 'Order', ),
        self::TYPE_CAMELNAME     => array('id', 'personId', 'name', 'uri', 'order', ),
        self::TYPE_COLNAME       => array(MenuLinkTableMap::COL_LINKID, MenuLinkTableMap::COL_LINKPERSONID, MenuLinkTableMap::COL_LINKNAME, MenuLinkTableMap::COL_LINKURI, MenuLinkTableMap::COL_LINKORDER, ),
        self::TYPE_FIELDNAME     => array('linkId', 'linkPersonId', 'linkName', 'linkUri', 'linkOrder', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'PersonId' => 1, 'Name' => 2, 'Uri' => 3, 'Order' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'personId' => 1, 'name' => 2, 'uri' => 3, 'order' => 4, ),
        self::TYPE_COLNAME       => array(MenuLinkTableMap::COL_LINKID => 0, MenuLinkTableMap::COL_LINKPERSONID => 1, MenuLinkTableMap::COL_LINKNAME => 2, MenuLinkTableMap::COL_LINKURI => 3, MenuLinkTableMap::COL_LINKORDER => 4, ),
        self::TYPE_FIELDNAME     => array('linkId' => 0, 'linkPersonId' => 1, 'linkName' => 2, 'linkUri' => 3, 'linkOrder' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\MenuLink');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('linkId', 'Id', 'SMALLINT', true, 8, null);
        $this->addForeignKey('linkPersonId', 'PersonId', 'SMALLINT', 'person_per', 'per_ID', false, 9, null);
        $this->addColumn('linkName', 'Name', 'VARCHAR', false, 50, null);
        $this->addColumn('linkUri', 'Uri', 'LONGVARCHAR', true, null, null);
        $this->addColumn('linkOrder', 'Order', 'INTEGER', true, null, null);
    } // initialize()
  ...
  array (
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'linkname','validator' => 'NotNull',), 'rule2' => array ('column' => 'linkname','validator' => 'Length','options' => array ('max' => 50,),), 'rule3' => array ('column' => 'linkuri','validator' => 'NotNull',), 'rule4' => array ('column' => 'linkuri','validator' => 'Length','options' => array ('max' => 500,),), ),
        );
    } // getBehaviors()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MenuLinkTableMap::COL_LINKPERSONID);
            ...
            $criteria->addSelectColumn($alias . '.linkPersonId');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\MenuLink) { // it's a model object
