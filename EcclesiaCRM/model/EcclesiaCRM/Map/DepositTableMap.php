...
class DepositTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.DepositTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Deposit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Deposit';
    ...
    /**
     * the column name for the dep_Fund field
     */
    const COL_DEP_FUND = 'deposit_dep.dep_Fund';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Date', 'Comment', 'Enteredby', 'Closed', 'Type', 'Fund', ),
        self::TYPE_CAMELNAME     => array('id', 'date', 'comment', 'enteredby', 'closed', 'type', 'fund', ),
        self::TYPE_COLNAME       => array(DepositTableMap::COL_DEP_ID, DepositTableMap::COL_DEP_DATE, DepositTableMap::COL_DEP_COMMENT, DepositTableMap::COL_DEP_ENTEREDBY, DepositTableMap::COL_DEP_CLOSED, DepositTableMap::COL_DEP_TYPE, DepositTableMap::COL_DEP_FUND, ),
        self::TYPE_FIELDNAME     => array('dep_ID', 'dep_Date', 'dep_Comment', 'dep_EnteredBy', 'dep_Closed', 'dep_Type', 'dep_Fund', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Date' => 1, 'Comment' => 2, 'Enteredby' => 3, 'Closed' => 4, 'Type' => 5, 'Fund' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'date' => 1, 'comment' => 2, 'enteredby' => 3, 'closed' => 4, 'type' => 5, 'fund' => 6, ),
        self::TYPE_COLNAME       => array(DepositTableMap::COL_DEP_ID => 0, DepositTableMap::COL_DEP_DATE => 1, DepositTableMap::COL_DEP_COMMENT => 2, DepositTableMap::COL_DEP_ENTEREDBY => 3, DepositTableMap::COL_DEP_CLOSED => 4, DepositTableMap::COL_DEP_TYPE => 5, DepositTableMap::COL_DEP_FUND => 6, ),
        self::TYPE_FIELDNAME     => array('dep_ID' => 0, 'dep_Date' => 1, 'dep_Comment' => 2, 'dep_EnteredBy' => 3, 'dep_Closed' => 4, 'dep_Type' => 5, 'dep_Fund' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Deposit');
        ...
        $this->addForeignKey('dep_Fund', 'Fund', 'SMALLINT', 'donationfund_fun', 'fun_ID', true, 6, 0);
    } // initialize()
    ...
    {
        $this->addRelation('DonationFund', '\\EcclesiaCRM\\DonationFund', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':dep_Fund',
    1 => ':fun_ID',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DepositTableMap::COL_DEP_FUND);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.dep_Fund');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Deposit) { // it's a model object
