...
class AutoPaymentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.AutoPaymentTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\AutoPayment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.AutoPayment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\AutoPayment');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('aut_ID', 'Id', 'SMALLINT', true, 9, null);
        $this->addForeignKey('aut_FamID', 'Familyid', 'SMALLINT', 'family_fam', 'fam_ID', true, 9, 0);
        ...
        $this->addForeignKey('aut_Fund', 'Fund', 'TINYINT', 'donationfund_fun', 'fun_ID', true, 3, null);
        ...
        $this->addForeignKey('aut_EditedBy', 'Editedby', 'SMALLINT', 'person_per', 'per_ID', false, 9, null);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\AutoPayment) { // it's a model object
