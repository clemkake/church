...
class EventCountNameTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EventCountNameTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EventCountName';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EventCountName';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EventCountName');
        $this->setPackage('EcclesiaCRM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('evctnm_countid', 'Id', 'INTEGER', true, 5, null);
        $this->addForeignKey('evctnm_eventtypeid', 'TypeId', 'SMALLINT', 'event_types', 'type_id', true, 5, 0);
    ...
    {
        $this->addRelation('EventTypes', '\\EcclesiaCRM\\EventTypes', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':evctnm_eventtypeid',
    1 => ':type_id',
  ),
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to eventcountnames_evctnm     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EventCountName) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(EventCountNameTableMap::DATABASE_NAME);
            $criteria->add(EventCountNameTableMap::COL_EVCTNM_COUNTID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(EventCountNameTableMap::COL_EVCTNM_COUNTID) && $criteria->keyContainsValue(EventCountNameTableMap::COL_EVCTNM_COUNTID) ) {
