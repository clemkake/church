...
class PropertyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PropertyTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Property';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Property';
    ...
    /**
     * the column name for the pro_Comment field
     */
    const COL_PRO_COMMENT = 'property_pro.pro_Comment';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ProId', 'ProClass', 'ProPrtId', 'ProName', 'ProDescription', 'ProPrompt', 'ProComment', ),
        self::TYPE_CAMELNAME     => array('proId', 'proClass', 'proPrtId', 'proName', 'proDescription', 'proPrompt', 'proComment', ),
        self::TYPE_COLNAME       => array(PropertyTableMap::COL_PRO_ID, PropertyTableMap::COL_PRO_CLASS, PropertyTableMap::COL_PRO_PRT_ID, PropertyTableMap::COL_PRO_NAME, PropertyTableMap::COL_PRO_DESCRIPTION, PropertyTableMap::COL_PRO_PROMPT, PropertyTableMap::COL_PRO_COMMENT, ),
        self::TYPE_FIELDNAME     => array('pro_ID', 'pro_Class', 'pro_prt_ID', 'pro_Name', 'pro_Description', 'pro_Prompt', 'pro_Comment', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ProId' => 0, 'ProClass' => 1, 'ProPrtId' => 2, 'ProName' => 3, 'ProDescription' => 4, 'ProPrompt' => 5, 'ProComment' => 6, ),
        self::TYPE_CAMELNAME     => array('proId' => 0, 'proClass' => 1, 'proPrtId' => 2, 'proName' => 3, 'proDescription' => 4, 'proPrompt' => 5, 'proComment' => 6, ),
        self::TYPE_COLNAME       => array(PropertyTableMap::COL_PRO_ID => 0, PropertyTableMap::COL_PRO_CLASS => 1, PropertyTableMap::COL_PRO_PRT_ID => 2, PropertyTableMap::COL_PRO_NAME => 3, PropertyTableMap::COL_PRO_DESCRIPTION => 4, PropertyTableMap::COL_PRO_PROMPT => 5, PropertyTableMap::COL_PRO_COMMENT => 6, ),
        self::TYPE_FIELDNAME     => array('pro_ID' => 0, 'pro_Class' => 1, 'pro_prt_ID' => 2, 'pro_Name' => 3, 'pro_Description' => 4, 'pro_Prompt' => 5, 'pro_Comment' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Property');
        ...
        $this->addColumn('pro_Comment', 'ProComment', 'LONGVARCHAR', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('PropertyType', '\\EcclesiaCRM\\PropertyType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':pro_prt_ID',
    1 => ':prt_ID',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PropertyTableMap::COL_PRO_COMMENT);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.pro_Comment');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Property) { // it's a model object
