...
class EventTypesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EventTypesTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EventTypes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EventTypes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EventTypes');
  ...
  array (
    ...
    1 => ':grp_ID',
        ...
        $this->addRelation('EventCountName', '\\EcclesiaCRM\\EventCountName', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':evctnm_eventtypeid',
    1 => ':type_id',
  ),
), 'CASCADE', null, 'EventCountNames', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to event_types     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EventTypesTableMap::COL_TYPE_GRPID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EventTypes) { // it's a model object
