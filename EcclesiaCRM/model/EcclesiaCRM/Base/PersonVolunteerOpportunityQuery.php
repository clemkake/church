 ...
 *
 * @method     ChildPersonVolunteerOpportunityQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildPersonVolunteerOpportunityQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildPersonVolunteerOpportunityQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     ChildPersonVolunteerOpportunityQuery joinWithPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Person relation
 *
 * @method     ChildPersonVolunteerOpportunityQuery leftJoinWithPerson() Adds a LEFT JOIN clause and with to the query using the Person relation
 * @method     ChildPersonVolunteerOpportunityQuery rightJoinWithPerson() Adds a RIGHT JOIN clause and with to the query using the Person relation
 * @method     ChildPersonVolunteerOpportunityQuery innerJoinWithPerson() Adds a INNER JOIN clause and with to the query using the Person relation
 *
 * @method     ChildPersonVolunteerOpportunityQuery leftJoinVolunteerOpportunity($relationAlias = null) Adds a LEFT JOIN clause to the query using the VolunteerOpportunity relation
 * @method     ChildPersonVolunteerOpportunityQuery rightJoinVolunteerOpportunity($relationAlias = null) Adds a RIGHT JOIN clause to the query using the VolunteerOpportunity relation
 * @method     ChildPersonVolunteerOpportunityQuery innerJoinVolunteerOpportunity($relationAlias = null) Adds a INNER JOIN clause to the query using the VolunteerOpportunity relation
 *
 * @method     ChildPersonVolunteerOpportunityQuery joinWithVolunteerOpportunity($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the VolunteerOpportunity relation
 *
 * @method     ChildPersonVolunteerOpportunityQuery leftJoinWithVolunteerOpportunity() Adds a LEFT JOIN clause and with to the query using the VolunteerOpportunity relation
 * @method     ChildPersonVolunteerOpportunityQuery rightJoinWithVolunteerOpportunity() Adds a RIGHT JOIN clause and with to the query using the VolunteerOpportunity relation
 * @method     ChildPersonVolunteerOpportunityQuery innerJoinWithVolunteerOpportunity() Adds a INNER JOIN clause and with to the query using the VolunteerOpportunity relation
 *
 * @method     \EcclesiaCRM\PersonQuery|\EcclesiaCRM\VolunteerOpportunityQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PersonVolunteerOpportunityQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\PersonVolunteerOpportunityQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\PersonVolunteerOpportunity', $modelAlias = null)
    {
     ...
     * </code>
     *
     * @see       filterByVolunteerOpportunity()
     *
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPersonVolunteerOpportunityQuery The current query, for fluid interface
     */
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \EcclesiaCRM\Person) {
            return $this
                ->addUsingAlias(PersonVolunteerOpportunityTableMap::COL_P2VO_PER_ID, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PersonVolunteerOpportunityTableMap::COL_P2VO_PER_ID, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\VolunteerOpportunity object
     *
     * @param \EcclesiaCRM\VolunteerOpportunity|ObjectCollection $volunteerOpportunity The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPersonVolunteerOpportunityQuery The current query, for fluid interface
     */
    public function filterByVolunteerOpportunity($volunteerOpportunity, $comparison = null)
    {
        if ($volunteerOpportunity instanceof \EcclesiaCRM\VolunteerOpportunity) {
            return $this
                ->addUsingAlias(PersonVolunteerOpportunityTableMap::COL_P2VO_VOL_ID, $volunteerOpportunity->getId(), $comparison);
        } elseif ($volunteerOpportunity instanceof ObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(PersonVolunteerOpportunityTableMap::COL_P2VO_VOL_ID, $volunteerOpportunity->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByVolunteerOpportunity() only accepts arguments of type \EcclesiaCRM\VolunteerOpportunity or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the VolunteerOpportunity relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonVolunteerOpportunityQuery The current query, for fluid interface
     */
    public function joinVolunteerOpportunity($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('VolunteerOpportunity');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'VolunteerOpportunity');
        }
    ...
    /**
     * Use the VolunteerOpportunity relation VolunteerOpportunity object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\VolunteerOpportunityQuery A secondary query class using the current class as primary query
     */
    public function useVolunteerOpportunityQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinVolunteerOpportunity($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'VolunteerOpportunity', '\EcclesiaCRM\VolunteerOpportunityQuery');
    }
