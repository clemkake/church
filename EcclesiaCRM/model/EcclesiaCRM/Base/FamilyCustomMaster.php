...
abstract class FamilyCustomMaster implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\FamilyCustomMasterTableMap';
    ...
    /**
     * The value for the family_custom_id field.
     *
     * @var        int
     */
    protected $family_custom_id;
    ...
    /**
     * The value for the fam_custom_comment field.
     * For GDPR
     * @var        string
     */
    protected $fam_custom_comment;
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\FamilyCustomMaster object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [family_custom_id] column value.
     *
     * @return int
     */
    public function getId()
    {
        return $this->family_custom_id;
    }
    ...
    /**
     * Get the [fam_custom_comment] column value.
     * For GDPR
     * @return string
     */
    public function getCustomComment()
    {
        return $this->fam_custom_comment;
    }
    ...
    /**
     * Set the value of [family_custom_id] column.
     *
     * @param int $v new value
     * @return $this|\EcclesiaCRM\FamilyCustomMaster The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->family_custom_id !== $v) {
            $this->family_custom_id = $v;
            $this->modifiedColumns[FamilyCustomMasterTableMap::COL_FAMILY_CUSTOM_ID] = true;
        }
    ...
    /**
     * Set the value of [fam_custom_comment] column.
     * For GDPR
     * @param string $v new value
     * @return $this|\EcclesiaCRM\FamilyCustomMaster The current object (for fluent API support)
     */
    public function setCustomComment($v)
    {
        ...
        if ($this->fam_custom_comment !== $v) {
            $this->fam_custom_comment = $v;
            $this->modifiedColumns[FamilyCustomMasterTableMap::COL_FAM_CUSTOM_COMMENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FamilyCustomMasterTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->family_custom_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomField', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_field = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomSpecial', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_special = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomSide', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_side = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomFieldSec', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_fieldsec = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FamilyCustomMasterTableMap::translateFieldName('CustomComment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_comment = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : FamilyCustomMasterTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = FamilyCustomMasterTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\FamilyCustomMaster'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAMILY_CUSTOM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'family_custom_id';
        }
        ...
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'fam_custom_comment';
        }
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'family_custom_id':
                        $stmt->bindValue($identifier, $this->family_custom_id, PDO::PARAM_INT);
                        break;
                    ...
                    case 'fam_custom_FieldSec':
                        ...
                        break;
                    case 'fam_custom_comment':
                        $stmt->bindValue($identifier, $this->fam_custom_comment, PDO::PARAM_STR);
                        break;
                    case 'type_ID':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\FamilyCustomMaster
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\FamilyCustomMaster The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAMILY_CUSTOM_ID)) {
            $criteria->add(FamilyCustomMasterTableMap::COL_FAMILY_CUSTOM_ID, $this->family_custom_id);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_ORDER)) {
        ...
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_COMMENT)) {
            $criteria->add(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_COMMENT, $this->fam_custom_comment);
        }
        if ($this->isColumnModified(FamilyCustomMasterTableMap::COL_TYPE_ID)) {
    ...
    {
        $criteria = ChildFamilyCustomMasterQuery::create();
        $criteria->add(FamilyCustomMasterTableMap::COL_FAMILY_CUSTOM_ID, $this->family_custom_id);
    ...
    /**
     * Generic method to set the primary key (family_custom_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\FamilyCustomMaster (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\FamilyCustomMaster Clone of current object.
     * @throws PropelException
     */
