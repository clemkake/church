 ...
 *
 * @method     ChildEventCountsQuery leftJoinEventCountName($relationAlias = null) Adds a LEFT JOIN clause to the query using the EventCountName relation
 * @method     ChildEventCountsQuery rightJoinEventCountName($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EventCountName relation
 * @method     ChildEventCountsQuery innerJoinEventCountName($relationAlias = null) Adds a INNER JOIN clause to the query using the EventCountName relation
 *
 * @method     ChildEventCountsQuery joinWithEventCountName($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the EventCountName relation
 *
 * @method     ChildEventCountsQuery leftJoinWithEventCountName() Adds a LEFT JOIN clause and with to the query using the EventCountName relation
 * @method     ChildEventCountsQuery rightJoinWithEventCountName() Adds a RIGHT JOIN clause and with to the query using the EventCountName relation
 * @method     ChildEventCountsQuery innerJoinWithEventCountName() Adds a INNER JOIN clause and with to the query using the EventCountName relation
 *
 * @method     ChildEventCountsQuery leftJoinEvent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Event relation
 * @method     ChildEventCountsQuery rightJoinEvent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Event relation
 * @method     ChildEventCountsQuery innerJoinEvent($relationAlias = null) Adds a INNER JOIN clause to the query using the Event relation
 *
 * @method     ChildEventCountsQuery joinWithEvent($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Event relation
 *
 * @method     ChildEventCountsQuery leftJoinWithEvent() Adds a LEFT JOIN clause and with to the query using the Event relation
 * @method     ChildEventCountsQuery rightJoinWithEvent() Adds a RIGHT JOIN clause and with to the query using the Event relation
 * @method     ChildEventCountsQuery innerJoinWithEvent() Adds a INNER JOIN clause and with to the query using the Event relation
 *
 * @method     \EcclesiaCRM\EventCountNameQuery|\EcclesiaCRM\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventCountsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\EventCountsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\EventCounts', $modelAlias = null)
    {
     ...
     *
     * @param \EcclesiaCRM\EventCountName|ObjectCollection $eventCountName The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildEventCountsQuery The current query, for fluid interface
     */
    public function filterByEventCountName($eventCountName, $comparison = null)
    {
        if ($eventCountName instanceof \EcclesiaCRM\EventCountName) {
            return $this
                ->addUsingAlias(EventCountsTableMap::COL_EVTCNT_COUNTID, $eventCountName->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventCountsTableMap::COL_EVTCNT_COUNTID, $eventCountName->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param \EcclesiaCRM\Event|ObjectCollection $event The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \EcclesiaCRM\Event) {
            return $this
                ->addUsingAlias(EventCountsTableMap::COL_EVTCNT_EVENTID, $event->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventCountsTableMap::COL_EVTCNT_EVENTID, $event->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
