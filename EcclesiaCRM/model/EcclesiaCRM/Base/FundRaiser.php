...
use \Exception;
use \PDO;
use EcclesiaCRM\FundRaiserQuery as ChildFundRaiserQuery;
use EcclesiaCRM\Map\FundRaiserTableMap;
...
abstract class FundRaiser implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\FundRaiserTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\FundRaiser object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|FundRaiser The current object, for fluid interface
     */
     ...
     * @return $this|\EcclesiaCRM\FundRaiser The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FundRaiserTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fr_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FundRaiserTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fr_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FundRaiserTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fr_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FundRaiserTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fr_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FundRaiserTableMap::translateFieldName('EnteredBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fr_enteredby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FundRaiserTableMap::translateFieldName('EnteredDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fr_entereddate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = FundRaiserTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\FundRaiser'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFundRaiserQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'fr_ID':
                        ...
                        break;
                    case 'fr_date':
                        $stmt->bindValue($identifier, $this->fr_date ? $this->fr_date->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'fr_title':
                    ...
                    case 'fr_EnteredBy':
                        ...
                        break;
                    case 'fr_EnteredDate':
                        $stmt->bindValue($identifier, $this->fr_entereddate ? $this->fr_entereddate->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\FundRaiser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\FundRaiser The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_ID)) {
            $criteria->add(FundRaiserTableMap::COL_FR_ID, $this->fr_id);
        }
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_DATE)) {
            $criteria->add(FundRaiserTableMap::COL_FR_DATE, $this->fr_date);
        }
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_TITLE)) {
            $criteria->add(FundRaiserTableMap::COL_FR_TITLE, $this->fr_title);
        }
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_DESCRIPTION)) {
            $criteria->add(FundRaiserTableMap::COL_FR_DESCRIPTION, $this->fr_description);
        }
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_ENTEREDBY)) {
            $criteria->add(FundRaiserTableMap::COL_FR_ENTEREDBY, $this->fr_enteredby);
        }
        if ($this->isColumnModified(FundRaiserTableMap::COL_FR_ENTEREDDATE)) {
            $criteria->add(FundRaiserTableMap::COL_FR_ENTEREDDATE, $this->fr_entereddate);
        }
    ...
    {
        $criteria = ChildFundRaiserQuery::create();
        $criteria->add(FundRaiserTableMap::COL_FR_ID, $this->fr_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\FundRaiser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\FundRaiser Clone of current object.
     * @throws PropelException
     */
