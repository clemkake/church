...
abstract class Pledge implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\PledgeTableMap';
    ...
    /**
     * @var        ChildAutoPayment
     */
    protected $aAutoPayment;
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\Pledge object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\Pledge The current object (for fluent API support)
     */
    ...
    public function setAutId($v)
    {
        ...
        if ($this->aAutoPayment !== null && $this->aAutoPayment->getId() !== $v) {
            $this->aAutoPayment = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\Pledge'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAutoPayment !== null && $this->plg_aut_id !== $this->aAutoPayment->getId()) {
            $this->aAutoPayment = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aAutoPayment !== null) {
                if ($this->aAutoPayment->isModified() || $this->aAutoPayment->isNew()) {
                    $affectedRows += $this->aAutoPayment->save($con);
                }
                $this->setAutoPayment($this->aAutoPayment);
            }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aAutoPayment) {
                ...
                $result[$key] = $this->aAutoPayment->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\Pledge
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\Pledge The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\Pledge (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\Pledge Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aDeposit === null && ($this->plg_depid != 0)) {
    ...
    {
        if ($this->aDonationFund === null && ($this->plg_fundid != 0)) {
    ...
    {
        if ($this->aFamily === null && ($this->plg_famid != 0)) {
    ...
    /**
     * Declares an association between this object and a ChildAutoPayment object.
     *
     * @param  ChildAutoPayment $v
     * @return $this|\EcclesiaCRM\Pledge The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAutoPayment(ChildAutoPayment $v = null)
    {
        if ($v === null) {
            $this->setAutId(0);
        } else {
            $this->setAutId($v->getId());
        }

        $this->aAutoPayment = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildAutoPayment object, it will not be re-added.
        if ($v !== null) {
            $v->addPledge($this);
        }
    ...
    /**
     * Get the associated ChildAutoPayment object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildAutoPayment The associated ChildAutoPayment object.
     * @throws PropelException
     */
    public function getAutoPayment(ConnectionInterface $con = null)
    {
        if ($this->aAutoPayment === null && ($this->plg_aut_id != 0)) {
            $this->aAutoPayment = ChildAutoPaymentQuery::create()->findPk($this->plg_aut_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAutoPayment->addPledges($this);
             */
        }

        return $this->aAutoPayment;
    }
    ...
    {
        if ($this->aPerson === null && ($this->plg_editedby != 0)) {
    ...
    public function clear()
    {
        ...
        if (null !== $this->aAutoPayment) {
            $this->aAutoPayment->removePledge($this);
        }
        if (null !== $this->aPerson) {
