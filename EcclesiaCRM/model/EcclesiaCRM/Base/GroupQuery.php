 ...
 *
 * @method     ChildGroupQuery leftJoinEventTypes($relationAlias = null) Adds a LEFT JOIN clause to the query using the EventTypes relation
 * @method     ChildGroupQuery rightJoinEventTypes($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EventTypes relation
 * @method     ChildGroupQuery innerJoinEventTypes($relationAlias = null) Adds a INNER JOIN clause to the query using the EventTypes relation
 *
 * @method     ChildGroupQuery joinWithEventTypes($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the EventTypes relation
 *
 * @method     ChildGroupQuery leftJoinWithEventTypes() Adds a LEFT JOIN clause and with to the query using the EventTypes relation
 * @method     ChildGroupQuery rightJoinWithEventTypes() Adds a RIGHT JOIN clause and with to the query using the EventTypes relation
 * @method     ChildGroupQuery innerJoinWithEventTypes() Adds a INNER JOIN clause and with to the query using the EventTypes relation
 *
 * @method     ChildGroupQuery leftJoinEvent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Event relation
 * @method     ChildGroupQuery rightJoinEvent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Event relation
 * @method     ChildGroupQuery innerJoinEvent($relationAlias = null) Adds a INNER JOIN clause to the query using the Event relation
 *
 * @method     ChildGroupQuery joinWithEvent($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Event relation
 *
 * @method     ChildGroupQuery leftJoinWithEvent() Adds a LEFT JOIN clause and with to the query using the Event relation
 * @method     ChildGroupQuery rightJoinWithEvent() Adds a RIGHT JOIN clause and with to the query using the Event relation
 * @method     ChildGroupQuery innerJoinWithEvent() Adds a INNER JOIN clause and with to the query using the Event relation
 *
 * @method     ChildGroupQuery leftJoinGroupManagerPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupManagerPerson relation
 * @method     ChildGroupQuery rightJoinGroupManagerPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupManagerPerson relation
 * @method     ChildGroupQuery innerJoinGroupManagerPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupManagerPerson relation
 *
 * @method     ChildGroupQuery joinWithGroupManagerPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the GroupManagerPerson relation
 *
 * @method     ChildGroupQuery leftJoinWithGroupManagerPerson() Adds a LEFT JOIN clause and with to the query using the GroupManagerPerson relation
 * @method     ChildGroupQuery rightJoinWithGroupManagerPerson() Adds a RIGHT JOIN clause and with to the query using the GroupManagerPerson relation
 * @method     ChildGroupQuery innerJoinWithGroupManagerPerson() Adds a INNER JOIN clause and with to the query using the GroupManagerPerson relation
 *
 * @method     \EcclesiaCRM\ListOptionQuery|\EcclesiaCRM\Person2group2roleP2g2rQuery|\EcclesiaCRM\EventTypesQuery|\EcclesiaCRM\EventQuery|\EcclesiaCRM\GroupManagerPersonQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildGroup findOneByHasSpecialProps(boolean $grp_hasSpecialProps) Return the first ChildGroup filtered by the grp_hasSpecialProps column
 * @method     ChildGroup findOneByActive(boolean $grp_active) Return the first ChildGroup filtered by the grp_active column
 * @method     ChildGroup findOneByIncludeInEmailExport(boolean $grp_include_email_export) Return the first ChildGroup filtered by the grp_include_email_export column *
...
abstract class GroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\GroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\Group', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\ListOption object
     *
     * @param \EcclesiaCRM\ListOption $listOption The related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($listOption instanceof \EcclesiaCRM\ListOption) {
            return $this
            ...
            throw new PropelException('filterByListOption() only accepts arguments of type \EcclesiaCRM\ListOption');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\ListOptionQuery A secondary query class using the current class as primary query
     */
    public function useListOptionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinListOption($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ListOption', '\EcclesiaCRM\ListOptionQuery');
    }
     ...
     *
     * @param \EcclesiaCRM\EventTypes|ObjectCollection $eventTypes the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildGroupQuery The current query, for fluid interface
     */
    public function filterByEventTypes($eventTypes, $comparison = null)
    {
        if ($eventTypes instanceof \EcclesiaCRM\EventTypes) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_GRP_ID, $eventTypes->getGroupId(), $comparison);
     ...
     * @return $this|ChildGroupQuery The current query, for fluid interface
     */
    public function joinEventTypes($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\Event object
     *
     * @param \EcclesiaCRM\Event|ObjectCollection $event the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildGroupQuery The current query, for fluid interface
     */
    ...
    {
        if ($event instanceof \EcclesiaCRM\Event) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_GRP_ID, $event->getGroupId(), $comparison);
            ...
            throw new PropelException('filterByEvent() only accepts arguments of type \EcclesiaCRM\Event or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\EventQuery A secondary query class using the current class as primary query
     */
    public function useEventQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinEvent($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Event', '\EcclesiaCRM\EventQuery');
    }
    ...
    public function filterByGroupManagerPerson($groupManagerPerson, $comparison = null)
    {
        if ($groupManagerPerson instanceof \EcclesiaCRM\GroupManagerPerson) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_GRP_ID, $groupManagerPerson->getGroupId(), $comparison);
