...
use \Exception;
use \PDO;
use EcclesiaCRM\CanvassDataQuery as ChildCanvassDataQuery;
...
abstract class CanvassData implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\CanvassDataTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\CanvassData object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|CanvassData The current object, for fluid interface
     */
     ...
     * @return $this|\EcclesiaCRM\CanvassData The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\CanvassData'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\CanvassData
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\CanvassData The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\CanvassData (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\CanvassData Clone of current object.
     * @throws PropelException
     */
