 ...
 * @method     ChildPersonQuery orderByFacebookID($order = Criteria::ASC) Order by the per_FacebookID column
 ...
 * @method     ChildPersonQuery orderByDateDeactivated($order = Criteria::ASC) Order by the per_DateDeactivated column
 *
 ...
 * @method     ChildPersonQuery groupByFacebookID() Group by the per_FacebookID column
 ...
 * @method     ChildPersonQuery groupByDateDeactivated() Group by the per_DateDeactivated column
 *
 ...
 *
 * @method     ChildPersonQuery leftJoinNoteShare($relationAlias = null) Adds a LEFT JOIN clause to the query using the NoteShare relation
 * @method     ChildPersonQuery rightJoinNoteShare($relationAlias = null) Adds a RIGHT JOIN clause to the query using the NoteShare relation
 * @method     ChildPersonQuery innerJoinNoteShare($relationAlias = null) Adds a INNER JOIN clause to the query using the NoteShare relation
 *
 * @method     ChildPersonQuery joinWithNoteShare($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the NoteShare relation
 *
 * @method     ChildPersonQuery leftJoinWithNoteShare() Adds a LEFT JOIN clause and with to the query using the NoteShare relation
 * @method     ChildPersonQuery rightJoinWithNoteShare() Adds a RIGHT JOIN clause and with to the query using the NoteShare relation
 * @method     ChildPersonQuery innerJoinWithNoteShare() Adds a INNER JOIN clause and with to the query using the NoteShare relation
 *
 ...
 *
 * @method     ChildPersonQuery leftJoinAutoPayment($relationAlias = null) Adds a LEFT JOIN clause to the query using the AutoPayment relation
 * @method     ChildPersonQuery rightJoinAutoPayment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AutoPayment relation
 * @method     ChildPersonQuery innerJoinAutoPayment($relationAlias = null) Adds a INNER JOIN clause to the query using the AutoPayment relation
 *
 * @method     ChildPersonQuery joinWithAutoPayment($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AutoPayment relation
 *
 * @method     ChildPersonQuery leftJoinWithAutoPayment() Adds a LEFT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildPersonQuery rightJoinWithAutoPayment() Adds a RIGHT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildPersonQuery innerJoinWithAutoPayment() Adds a INNER JOIN clause and with to the query using the AutoPayment relation
 *
 ...
 *
 * @method     ChildPersonQuery leftJoinPersonVolunteerOpportunity($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonVolunteerOpportunity relation
 * @method     ChildPersonQuery rightJoinPersonVolunteerOpportunity($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonVolunteerOpportunity relation
 * @method     ChildPersonQuery innerJoinPersonVolunteerOpportunity($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonVolunteerOpportunity relation
 *
 * @method     ChildPersonQuery joinWithPersonVolunteerOpportunity($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PersonVolunteerOpportunity relation
 *
 * @method     ChildPersonQuery leftJoinWithPersonVolunteerOpportunity() Adds a LEFT JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 * @method     ChildPersonQuery rightJoinWithPersonVolunteerOpportunity() Adds a RIGHT JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 * @method     ChildPersonQuery innerJoinWithPersonVolunteerOpportunity() Adds a INNER JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 *
 * @method     ChildPersonQuery leftJoinGroupManagerPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupManagerPerson relation
 * @method     ChildPersonQuery rightJoinGroupManagerPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupManagerPerson relation
 * @method     ChildPersonQuery innerJoinGroupManagerPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupManagerPerson relation
 *
 * @method     ChildPersonQuery joinWithGroupManagerPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the GroupManagerPerson relation
 *
 * @method     ChildPersonQuery leftJoinWithGroupManagerPerson() Adds a LEFT JOIN clause and with to the query using the GroupManagerPerson relation
 * @method     ChildPersonQuery rightJoinWithGroupManagerPerson() Adds a RIGHT JOIN clause and with to the query using the GroupManagerPerson relation
 * @method     ChildPersonQuery innerJoinWithGroupManagerPerson() Adds a INNER JOIN clause and with to the query using the GroupManagerPerson relation
 *
 * @method     ChildPersonQuery leftJoinCKEditorTemplates($relationAlias = null) Adds a LEFT JOIN clause to the query using the CKEditorTemplates relation
 * @method     ChildPersonQuery rightJoinCKEditorTemplates($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CKEditorTemplates relation
 * @method     ChildPersonQuery innerJoinCKEditorTemplates($relationAlias = null) Adds a INNER JOIN clause to the query using the CKEditorTemplates relation
 *
 * @method     ChildPersonQuery joinWithCKEditorTemplates($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the CKEditorTemplates relation
 *
 * @method     ChildPersonQuery leftJoinWithCKEditorTemplates() Adds a LEFT JOIN clause and with to the query using the CKEditorTemplates relation
 * @method     ChildPersonQuery rightJoinWithCKEditorTemplates() Adds a RIGHT JOIN clause and with to the query using the CKEditorTemplates relation
 * @method     ChildPersonQuery innerJoinWithCKEditorTemplates() Adds a INNER JOIN clause and with to the query using the CKEditorTemplates relation
 *
 * @method     ChildPersonQuery leftJoinPastoralCareRelatedByPastorId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PastoralCareRelatedByPastorId relation
 * @method     ChildPersonQuery rightJoinPastoralCareRelatedByPastorId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PastoralCareRelatedByPastorId relation
 * @method     ChildPersonQuery innerJoinPastoralCareRelatedByPastorId($relationAlias = null) Adds a INNER JOIN clause to the query using the PastoralCareRelatedByPastorId relation
 *
 * @method     ChildPersonQuery joinWithPastoralCareRelatedByPastorId($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PastoralCareRelatedByPastorId relation
 *
 * @method     ChildPersonQuery leftJoinWithPastoralCareRelatedByPastorId() Adds a LEFT JOIN clause and with to the query using the PastoralCareRelatedByPastorId relation
 * @method     ChildPersonQuery rightJoinWithPastoralCareRelatedByPastorId() Adds a RIGHT JOIN clause and with to the query using the PastoralCareRelatedByPastorId relation
 * @method     ChildPersonQuery innerJoinWithPastoralCareRelatedByPastorId() Adds a INNER JOIN clause and with to the query using the PastoralCareRelatedByPastorId relation
 *
 * @method     ChildPersonQuery leftJoinPastoralCareRelatedByPersonId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PastoralCareRelatedByPersonId relation
 * @method     ChildPersonQuery rightJoinPastoralCareRelatedByPersonId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PastoralCareRelatedByPersonId relation
 * @method     ChildPersonQuery innerJoinPastoralCareRelatedByPersonId($relationAlias = null) Adds a INNER JOIN clause to the query using the PastoralCareRelatedByPersonId relation
 *
 * @method     ChildPersonQuery joinWithPastoralCareRelatedByPersonId($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PastoralCareRelatedByPersonId relation
 *
 * @method     ChildPersonQuery leftJoinWithPastoralCareRelatedByPersonId() Adds a LEFT JOIN clause and with to the query using the PastoralCareRelatedByPersonId relation
 * @method     ChildPersonQuery rightJoinWithPastoralCareRelatedByPersonId() Adds a RIGHT JOIN clause and with to the query using the PastoralCareRelatedByPersonId relation
 * @method     ChildPersonQuery innerJoinWithPastoralCareRelatedByPersonId() Adds a INNER JOIN clause and with to the query using the PastoralCareRelatedByPersonId relation
 *
 * @method     ChildPersonQuery leftJoinMenuLink($relationAlias = null) Adds a LEFT JOIN clause to the query using the MenuLink relation
 * @method     ChildPersonQuery rightJoinMenuLink($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MenuLink relation
 * @method     ChildPersonQuery innerJoinMenuLink($relationAlias = null) Adds a INNER JOIN clause to the query using the MenuLink relation
 *
 * @method     ChildPersonQuery joinWithMenuLink($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the MenuLink relation
 *
 * @method     ChildPersonQuery leftJoinWithMenuLink() Adds a LEFT JOIN clause and with to the query using the MenuLink relation
 * @method     ChildPersonQuery rightJoinWithMenuLink() Adds a RIGHT JOIN clause and with to the query using the MenuLink relation
 * @method     ChildPersonQuery innerJoinWithMenuLink() Adds a INNER JOIN clause and with to the query using the MenuLink relation
 *
 * @method     \EcclesiaCRM\FamilyQuery|\EcclesiaCRM\PersonCustomQuery|\EcclesiaCRM\NoteQuery|\EcclesiaCRM\NoteShareQuery|\EcclesiaCRM\Person2group2roleP2g2rQuery|\EcclesiaCRM\AutoPaymentQuery|\EcclesiaCRM\EventAttendQuery|\EcclesiaCRM\PledgeQuery|\EcclesiaCRM\UserQuery|\EcclesiaCRM\PersonVolunteerOpportunityQuery|\EcclesiaCRM\GroupManagerPersonQuery|\EcclesiaCRM\CKEditorTemplatesQuery|\EcclesiaCRM\PastoralCareQuery|\EcclesiaCRM\MenuLinkQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPerson findOneByGender(int $per_Gender) Return the first ChildPerson filtered by the per_Gender column
 ...
 * @method     ChildPerson findOneByFacebookID(string $per_FacebookID) Return the first ChildPerson filtered by the per_FacebookID column
 * @method     ChildPerson findOneByTwitter(string $per_Twitter) Return the first ChildPerson filtered by the per_Twitter column
 * @method     ChildPerson findOneByLinkedIn(string $per_LinkedIn) Return the first ChildPerson filtered by the per_LinkedIn column
 * @method     ChildPerson findOneByDateDeactivated(string $per_DateDeactivated) Return the first ChildPerson filtered by the per_DateDeactivated column *
 ...
 * @method     ChildPerson requireOneByFacebookID(string $per_FacebookID) Return the first ChildPerson filtered by the per_FacebookID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPerson requireOneByDateDeactivated(string $per_DateDeactivated) Return the first ChildPerson filtered by the per_DateDeactivated column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPerson[]|ObjectCollection findByFacebookID(string $per_FacebookID) Return ChildPerson objects filtered by the per_FacebookID column
 ...
 * @method     ChildPerson[]|ObjectCollection findByDateDeactivated(string $per_DateDeactivated) Return ChildPerson objects filtered by the per_DateDeactivated column
...
abstract class PersonQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\PersonQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\Person', $modelAlias = null)
    {
    ...
    /**
     * Filter the query on the per_FacebookID column
     *
     * Example usage:
     * <code>
     * $query->filterByFacebookID(1234); // WHERE per_FacebookID = 1234
     * $query->filterByFacebookID(array(12, 34)); // WHERE per_FacebookID IN (12, 34)
     * $query->filterByFacebookID(array('min' => 12)); // WHERE per_FacebookID > 12
     * </code>
     *
    ...
    public function filterByFacebookID($facebookID = null, $comparison = null)
    {
        if (is_array($facebookID)) {
            ...
            if (isset($facebookID['min'])) {
                $this->addUsingAlias(PersonTableMap::COL_PER_FACEBOOKID, $facebookID['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($facebookID['max'])) {
                $this->addUsingAlias(PersonTableMap::COL_PER_FACEBOOKID, $facebookID['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTableMap::COL_PER_FACEBOOKID, $facebookID, $comparison);
    }
    ...
    public function filterByDateDeactivated($dateDeactivated = null, $comparison = null)
    {
        if (is_array($dateDeactivated)) {
            ...
            if (isset($dateDeactivated['min'])) {
                $this->addUsingAlias(PersonTableMap::COL_PER_DATEDEACTIVATED, $dateDeactivated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateDeactivated['max'])) {
                $this->addUsingAlias(PersonTableMap::COL_PER_DATEDEACTIVATED, $dateDeactivated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTableMap::COL_PER_DATEDEACTIVATED, $dateDeactivated, $comparison);
    }
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\PersonCustom object
     *
     * @param \EcclesiaCRM\PersonCustom|ObjectCollection $personCustom the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($personCustom instanceof \EcclesiaCRM\PersonCustom) {
            return $this
            ...
            throw new PropelException('filterByPersonCustom() only accepts arguments of type \EcclesiaCRM\PersonCustom or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\PersonCustomQuery A secondary query class using the current class as primary query
     */
    public function usePersonCustomQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PersonCustom', '\EcclesiaCRM\PersonCustomQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\Note object
     *
     * @param \EcclesiaCRM\Note|ObjectCollection $note the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    public function filterByNoteShare($noteShare, $comparison = null)
    {
        if ($noteShare instanceof \EcclesiaCRM\NoteShare) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $noteShare->getSharePerId(), $comparison);
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\Person2group2roleP2g2r object
     *
     * @param \EcclesiaCRM\Person2group2roleP2g2r|ObjectCollection $person2group2roleP2g2r the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($person2group2roleP2g2r instanceof \EcclesiaCRM\Person2group2roleP2g2r) {
            return $this
            ...
            throw new PropelException('filterByPerson2group2roleP2g2r() only accepts arguments of type \EcclesiaCRM\Person2group2roleP2g2r or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\Person2group2roleP2g2rQuery A secondary query class using the current class as primary query
     */
    public function usePerson2group2roleP2g2rQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Person2group2roleP2g2r', '\EcclesiaCRM\Person2group2roleP2g2rQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\AutoPayment object
     *
     * @param \EcclesiaCRM\AutoPayment|ObjectCollection $autoPayment the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByAutoPayment($autoPayment, $comparison = null)
    {
        if ($autoPayment instanceof \EcclesiaCRM\AutoPayment) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $autoPayment->getEditedby(), $comparison);
        } elseif ($autoPayment instanceof ObjectCollection) {
            return $this
                ->useAutoPaymentQuery()
                ->filterByPrimaryKeys($autoPayment->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByAutoPayment() only accepts arguments of type \EcclesiaCRM\AutoPayment or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the AutoPayment relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinAutoPayment($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('AutoPayment');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'AutoPayment');
        }
    ...
    /**
     * Use the AutoPayment relation AutoPayment object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\AutoPaymentQuery A secondary query class using the current class as primary query
     */
    public function useAutoPaymentQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinAutoPayment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'AutoPayment', '\EcclesiaCRM\AutoPaymentQuery');
    }
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\Pledge object
     *
     * @param \EcclesiaCRM\Pledge|ObjectCollection $pledge the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($pledge instanceof \EcclesiaCRM\Pledge) {
            return $this
            ...
            throw new PropelException('filterByPledge() only accepts arguments of type \EcclesiaCRM\Pledge or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\PledgeQuery A secondary query class using the current class as primary query
     */
    public function usePledgeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPledge($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Pledge', '\EcclesiaCRM\PledgeQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\User object
     *
     * @param \EcclesiaCRM\User|ObjectCollection $user the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($user instanceof \EcclesiaCRM\User) {
            return $this
            ...
            throw new PropelException('filterByUser() only accepts arguments of type \EcclesiaCRM\User or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\EcclesiaCRM\UserQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\PersonVolunteerOpportunity object
     *
     * @param \EcclesiaCRM\PersonVolunteerOpportunity|ObjectCollection $personVolunteerOpportunity the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByPersonVolunteerOpportunity($personVolunteerOpportunity, $comparison = null)
    {
        if ($personVolunteerOpportunity instanceof \EcclesiaCRM\PersonVolunteerOpportunity) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $personVolunteerOpportunity->getPersonId(), $comparison);
        } elseif ($personVolunteerOpportunity instanceof ObjectCollection) {
            return $this
                ->usePersonVolunteerOpportunityQuery()
                ->filterByPrimaryKeys($personVolunteerOpportunity->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPersonVolunteerOpportunity() only accepts arguments of type \EcclesiaCRM\PersonVolunteerOpportunity or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PersonVolunteerOpportunity relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinPersonVolunteerOpportunity($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PersonVolunteerOpportunity');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PersonVolunteerOpportunity');
        }
    ...
    /**
     * Use the PersonVolunteerOpportunity relation PersonVolunteerOpportunity object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\PersonVolunteerOpportunityQuery A secondary query class using the current class as primary query
     */
    public function usePersonVolunteerOpportunityQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinPersonVolunteerOpportunity($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PersonVolunteerOpportunity', '\EcclesiaCRM\PersonVolunteerOpportunityQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\GroupManagerPerson object
     *
     * @param \EcclesiaCRM\GroupManagerPerson|ObjectCollection $groupManagerPerson the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByGroupManagerPerson($groupManagerPerson, $comparison = null)
    {
        if ($groupManagerPerson instanceof \EcclesiaCRM\GroupManagerPerson) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $groupManagerPerson->getPersonId(), $comparison);
        } elseif ($groupManagerPerson instanceof ObjectCollection) {
            return $this
                ->useGroupManagerPersonQuery()
                ->filterByPrimaryKeys($groupManagerPerson->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByGroupManagerPerson() only accepts arguments of type \EcclesiaCRM\GroupManagerPerson or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the GroupManagerPerson relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinGroupManagerPerson($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('GroupManagerPerson');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'GroupManagerPerson');
        }
    ...
    /**
     * Use the GroupManagerPerson relation GroupManagerPerson object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\GroupManagerPersonQuery A secondary query class using the current class as primary query
     */
    public function useGroupManagerPersonQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinGroupManagerPerson($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'GroupManagerPerson', '\EcclesiaCRM\GroupManagerPersonQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\CKEditorTemplates object
     *
     * @param \EcclesiaCRM\CKEditorTemplates|ObjectCollection $cKEditorTemplates the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByCKEditorTemplates($cKEditorTemplates, $comparison = null)
    {
        if ($cKEditorTemplates instanceof \EcclesiaCRM\CKEditorTemplates) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $cKEditorTemplates->getPersonId(), $comparison);
        } elseif ($cKEditorTemplates instanceof ObjectCollection) {
            return $this
                ->useCKEditorTemplatesQuery()
                ->filterByPrimaryKeys($cKEditorTemplates->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCKEditorTemplates() only accepts arguments of type \EcclesiaCRM\CKEditorTemplates or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CKEditorTemplates relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinCKEditorTemplates($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CKEditorTemplates');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CKEditorTemplates');
        }
    ...
    /**
     * Use the CKEditorTemplates relation CKEditorTemplates object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\CKEditorTemplatesQuery A secondary query class using the current class as primary query
     */
    public function useCKEditorTemplatesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCKEditorTemplates($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CKEditorTemplates', '\EcclesiaCRM\CKEditorTemplatesQuery');
    }
     ...
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByPastoralCareRelatedByPastorId($pastoralCare, $comparison = null)
    {
        if ($pastoralCare instanceof \EcclesiaCRM\PastoralCare) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $pastoralCare->getPastorId(), $comparison);
        } elseif ($pastoralCare instanceof ObjectCollection) {
            return $this
                ->usePastoralCareRelatedByPastorIdQuery()
                ->filterByPrimaryKeys($pastoralCare->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPastoralCareRelatedByPastorId() only accepts arguments of type \EcclesiaCRM\PastoralCare or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PastoralCareRelatedByPastorId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinPastoralCareRelatedByPastorId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PastoralCareRelatedByPastorId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PastoralCareRelatedByPastorId');
        }
    ...
    /**
     * Use the PastoralCareRelatedByPastorId relation PastoralCare object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function usePastoralCareRelatedByPastorIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinPastoralCareRelatedByPastorId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PastoralCareRelatedByPastorId', '\EcclesiaCRM\PastoralCareQuery');
    }
     ...
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByPastoralCareRelatedByPersonId($pastoralCare, $comparison = null)
    {
        if ($pastoralCare instanceof \EcclesiaCRM\PastoralCare) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $pastoralCare->getPersonId(), $comparison);
        } elseif ($pastoralCare instanceof ObjectCollection) {
            return $this
            ...
            throw new PropelException('filterByPastoralCareRelatedByPersonId() only accepts arguments of type \EcclesiaCRM\PastoralCare or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PastoralCareRelatedByPersonId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinPastoralCareRelatedByPersonId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PastoralCareRelatedByPersonId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PastoralCareRelatedByPersonId');
        }
    ...
    /**
     * Use the PastoralCareRelatedByPersonId relation PastoralCare object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return \EcclesiaCRM\PastoralCareQuery A secondary query class using the current class as primary query
     */
    public function usePastoralCareRelatedByPersonIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPastoralCareRelatedByPersonId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PastoralCareRelatedByPersonId', '\EcclesiaCRM\PastoralCareQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\MenuLink object
     *
     * @param \EcclesiaCRM\MenuLink|ObjectCollection $menuLink the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByMenuLink($menuLink, $comparison = null)
    {
        if ($menuLink instanceof \EcclesiaCRM\MenuLink) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $menuLink->getPersonId(), $comparison);
        } elseif ($menuLink instanceof ObjectCollection) {
            return $this
                ->useMenuLinkQuery()
                ->filterByPrimaryKeys($menuLink->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByMenuLink() only accepts arguments of type \EcclesiaCRM\MenuLink or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the MenuLink relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPersonQuery The current query, for fluid interface
     */
    public function joinMenuLink($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('MenuLink');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'MenuLink');
        }
    ...
    /**
     * Use the MenuLink relation MenuLink object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\MenuLinkQuery A secondary query class using the current class as primary query
     */
    public function useMenuLinkQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinMenuLink($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MenuLink', '\EcclesiaCRM\MenuLinkQuery');
    }
