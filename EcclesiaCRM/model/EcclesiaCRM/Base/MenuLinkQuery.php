 ...
 * @method     ChildMenuLinkQuery orderByPersonId($order = Criteria::ASC) Order by the linkPersonId column
 ...
 * @method     ChildMenuLinkQuery groupByPersonId() Group by the linkPersonId column
 ...
 *
 * @method     ChildMenuLinkQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildMenuLinkQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildMenuLinkQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     ChildMenuLinkQuery joinWithPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Person relation
 *
 * @method     ChildMenuLinkQuery leftJoinWithPerson() Adds a LEFT JOIN clause and with to the query using the Person relation
 * @method     ChildMenuLinkQuery rightJoinWithPerson() Adds a RIGHT JOIN clause and with to the query using the Person relation
 * @method     ChildMenuLinkQuery innerJoinWithPerson() Adds a INNER JOIN clause and with to the query using the Person relation
 *
 ...
 * @method     ChildMenuLink findOneByPersonId(int $linkPersonId) Return the first ChildMenuLink filtered by the linkPersonId column
 ...
 * @method     ChildMenuLink requireOneByPersonId(int $linkPersonId) Return the first ChildMenuLink filtered by the linkPersonId column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildMenuLink[]|ObjectCollection findByPersonId(int $linkPersonId) Return ChildMenuLink objects filtered by the linkPersonId column
...
abstract class MenuLinkQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\MenuLinkQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\MenuLink', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT linkId, linkPersonId, linkName, linkUri, linkOrder FROM menu_links WHERE linkId = :p0';
        try {
    ...
    /**
     * Filter the query on the linkPersonId column
     *
     * Example usage:
     * <code>
     * $query->filterByPersonId(1234); // WHERE linkPersonId = 1234
     * $query->filterByPersonId(array(12, 34)); // WHERE linkPersonId IN (12, 34)
     * $query->filterByPersonId(array('min' => 12)); // WHERE linkPersonId > 12
     * </code>
     *
     * @see       filterByPerson()
     *
    ...
    public function filterByPersonId($personId = null, $comparison = null)
    {
        if (is_array($personId)) {
            ...
            if (isset($personId['min'])) {
                $this->addUsingAlias(MenuLinkTableMap::COL_LINKPERSONID, $personId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($personId['max'])) {
                $this->addUsingAlias(MenuLinkTableMap::COL_LINKPERSONID, $personId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuLinkTableMap::COL_LINKPERSONID, $personId, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildMenuLinkQuery The current query, for fluid interface
     */
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \EcclesiaCRM\Person) {
            return $this
                ->addUsingAlias(MenuLinkTableMap::COL_LINKPERSONID, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(MenuLinkTableMap::COL_LINKPERSONID, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
