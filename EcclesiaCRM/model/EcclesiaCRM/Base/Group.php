...
use EcclesiaCRM\ListOption as ChildListOption;
use EcclesiaCRM\ListOptionQuery as ChildListOptionQuery;
...
abstract class Group implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\GroupTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\Group object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\Group The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\Group'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->eventTypessScheduledForDeletion !== null) {
                if (!$this->eventTypessScheduledForDeletion->isEmpty()) {
                    foreach ($this->eventTypessScheduledForDeletion as $eventTypes) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\Group The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\Group (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\Group Clone of current object.
     * @throws PropelException
     */
     ...
     */
    public function resetPartialEventTypess($v = true)
    {
     ...
     * @return void
     */
    public function initEventTypess($overrideExisting = true)
    {
        ...
        $this->collEventTypess->setModel('\EcclesiaCRM\EventTypes');
    }
    ...
    public function setEventTypess(Collection $eventTypess, ConnectionInterface $con = null)
    {
        ...
        foreach ($eventTypessToDelete as $eventTypesRemoved) {
            $eventTypesRemoved->setGroup(null);
        }
     ...
     * @throws PropelException
     */
    public function countEventTypess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collEventTypessPartial && !$this->isNew();
        if (null === $this->collEventTypess || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collEventTypess) {
     ...
     */
    protected function doAddEventTypes(ChildEventTypes $eventTypes)
    {
        $this->collEventTypess[]= $eventTypes;
        $eventTypes->setGroup($this);
    }
    ...
    public function removeEventTypes(ChildEventTypes $eventTypes)
    {
        if ($this->getEventTypess()->contains($eventTypes)) {
            ...
            $this->eventTypessScheduledForDeletion[]= $eventTypes;
            $eventTypes->setGroup(null);
        }
    ...
    public function initEvents($overrideExisting = true)
    {
        ...
        $this->collEvents->setModel('\EcclesiaCRM\Event');
    }
    ...
    public function setGroupManagerpeople(Collection $groupManagerpeople, ConnectionInterface $con = null)
    {
        ...
        foreach ($groupManagerpeopleToDelete as $groupManagerPersonRemoved) {
            $groupManagerPersonRemoved->setGroup(null);
        }
    ...
    protected function doAddGroupManagerPerson(ChildGroupManagerPerson $groupManagerPerson)
    {
        ...
        $groupManagerPerson->setGroup($this);
    }
    ...
    public function removeGroupManagerPerson(ChildGroupManagerPerson $groupManagerPerson)
    {
        if ($this->getGroupManagerpeople()->contains($groupManagerPerson)) {
            ...
            $groupManagerPerson->setGroup(null);
        }
     ...
     * @return ObjectCollection|ChildGroupManagerPerson[] List of ChildGroupManagerPerson objects
     */
    public function getGroupManagerpeopleJoinPerson(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGroupManagerPersonQuery::create(null, $criteria);
        $query->joinWith('Person', $joinBehavior);
