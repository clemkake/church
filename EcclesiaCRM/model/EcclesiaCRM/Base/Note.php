...
abstract class Note implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\NoteTableMap';
    ...
    /**
     * The value for the nte_title field.
     *
    ...
    /**
     * The value for the nte_info field.
     *
     * @var        string
     */
    protected $nte_info;
    ...
    /**
     * The value for the nte_iseditedby field.
     *
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $nte_iseditedby;

    /**
     * The value for the nte_iseditedbydate field.
     *
     * @var        DateTime
     */
    protected $nte_iseditedbydate;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->nte_editedby = 0;
        $this->nte_iseditedby = 0;
    }

    /**
     * Initializes internal state of EcclesiaCRM\Base\Note object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [nte_title] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [nte_info] column value.
     *
     * @return string
     */
    public function getInfo()
    {
        return $this->nte_info;
    }

    /**
     * Get the [nte_iseditedby] column value.
     *
     * @return int
     */
    public function getCurrentEditedBy()
    {
        return $this->nte_iseditedby;
    }

    /**
     * Get the [optionally formatted] temporal [nte_iseditedbydate] column value.
     *
     *
     * @param      string|null $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getCurrentEditedDate($format = NULL)
    {
        if ($format === null) {
            return $this->nte_iseditedbydate;
        } else {
            return $this->nte_iseditedbydate instanceof \DateTimeInterface ? $this->nte_iseditedbydate->format($format) : null;
        }
    }
     ...
     * @return $this|\EcclesiaCRM\Note The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [nte_title] column.
     *
    ...
    public function setTitle($v)
    {
        ...
        if ($this->nte_title !== $v) {
            $this->nte_title = $v;
            $this->modifiedColumns[NoteTableMap::COL_NTE_TITLE] = true;
        }
    ...
    /**
     * Set the value of [nte_info] column.
     *
     * @param string $v new value
     * @return $this|\EcclesiaCRM\Note The current object (for fluent API support)
     */
    public function setInfo($v)
    {
        ...
        if ($this->nte_info !== $v) {
            $this->nte_info = $v;
            $this->modifiedColumns[NoteTableMap::COL_NTE_INFO] = true;
        }
    ...
    /**
     * Set the value of [nte_iseditedby] column.
     *
     * @param int $v new value
     * @return $this|\EcclesiaCRM\Note The current object (for fluent API support)
     */
    public function setCurrentEditedBy($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->nte_iseditedby !== $v) {
            $this->nte_iseditedby = $v;
            $this->modifiedColumns[NoteTableMap::COL_NTE_ISEDITEDBY] = true;
        }
    ...
    /**
     * Sets the value of [nte_iseditedbydate] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\EcclesiaCRM\Note The current object (for fluent API support)
     */
    public function setCurrentEditedDate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->nte_iseditedbydate !== null || $dt !== null) {
            if ($this->nte_iseditedbydate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->nte_iseditedbydate->format("Y-m-d H:i:s.u")) {
                $this->nte_iseditedbydate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[NoteTableMap::COL_NTE_ISEDITEDBYDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NoteTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : NoteTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : NoteTableMap::translateFieldName('DateEntered', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->nte_dateentered = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : NoteTableMap::translateFieldName('DateLastEdited', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->nte_datelastedited = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : NoteTableMap::translateFieldName('EnteredBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_enteredby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : NoteTableMap::translateFieldName('EditedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_editedby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : NoteTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : NoteTableMap::translateFieldName('Info', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_info = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : NoteTableMap::translateFieldName('CurrentEditedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nte_iseditedby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : NoteTableMap::translateFieldName('CurrentEditedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->nte_iseditedbydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
            ...
            return $startcol + 14; // 14 = NoteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\Note'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NoteTableMap::COL_NTE_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'nte_Title';
        }
        ...
        if ($this->isColumnModified(NoteTableMap::COL_NTE_INFO)) {
            $modifiedColumns[':p' . $index++]  = 'nte_Info';
        }
        if ($this->isColumnModified(NoteTableMap::COL_NTE_ISEDITEDBY)) {
            $modifiedColumns[':p' . $index++]  = 'nte_isEditedBy';
        }
        if ($this->isColumnModified(NoteTableMap::COL_NTE_ISEDITEDBYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'nte_isEditedByDate';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'nte_Private':
                        ...
                        break;
                    case 'nte_Title':
                        $stmt->bindValue($identifier, $this->nte_title, PDO::PARAM_STR);
                        break;
                    case 'nte_Text':
                    ...
                    case 'nte_Type':
                        ...
                        break;
                    case 'nte_Info':
                        $stmt->bindValue($identifier, $this->nte_info, PDO::PARAM_STR);
                        break;
                    case 'nte_isEditedBy':
                        $stmt->bindValue($identifier, $this->nte_iseditedby, PDO::PARAM_INT);
                        break;
                    case 'nte_isEditedByDate':
                        $stmt->bindValue($identifier, $this->nte_iseditedbydate ? $this->nte_iseditedbydate->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 11:
                ...
                break;
            case 12:
                return $this->getCurrentEditedBy();
                break;
            case 13:
                return $this->getCurrentEditedDate();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[7] => $this->getDateLastEdited(),
            $keys[8] => $this->getEnteredBy(),
            $keys[9] => $this->getEditedBy(),
            $keys[10] => $this->getType(),
            $keys[11] => $this->getInfo(),
            $keys[12] => $this->getCurrentEditedBy(),
            $keys[13] => $this->getCurrentEditedDate(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 11:
                ...
                break;
            case 12:
                $this->setCurrentEditedBy($value);
                break;
            case 13:
                $this->setCurrentEditedDate($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setDateEntered($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDateLastEdited($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setEnteredBy($arr[$keys[8]]);
        }
        ...
        if (array_key_exists($keys[11], $arr)) {
            $this->setInfo($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setCurrentEditedBy($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setCurrentEditedDate($arr[$keys[13]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\Note The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NoteTableMap::COL_NTE_TITLE)) {
            $criteria->add(NoteTableMap::COL_NTE_TITLE, $this->nte_title);
        }
        if ($this->isColumnModified(NoteTableMap::COL_NTE_TEXT)) {
        ...
        if ($this->isColumnModified(NoteTableMap::COL_NTE_INFO)) {
            $criteria->add(NoteTableMap::COL_NTE_INFO, $this->nte_info);
        }
        if ($this->isColumnModified(NoteTableMap::COL_NTE_ISEDITEDBY)) {
            $criteria->add(NoteTableMap::COL_NTE_ISEDITEDBY, $this->nte_iseditedby);
        }
        if ($this->isColumnModified(NoteTableMap::COL_NTE_ISEDITEDBYDATE)) {
            $criteria->add(NoteTableMap::COL_NTE_ISEDITEDBYDATE, $this->nte_iseditedbydate);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\Note (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCurrentEditedBy($this->getCurrentEditedBy());
        $copyObj->setCurrentEditedDate($this->getCurrentEditedDate());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\Note Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aFamily === null && ($this->nte_fam_id != 0)) {
    ...
    {
        if ($this->aPerson === null && ($this->nte_per_id != 0)) {
     ...
     * @return ObjectCollection|ChildNoteShare[] List of ChildNoteShare objects
     */
    public function getNoteSharesJoinPerson(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildNoteShareQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->nte_type = null;
        $this->nte_info = null;
        $this->nte_iseditedby = null;
        $this->nte_iseditedbydate = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
        $this->resetModified();
