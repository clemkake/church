...
abstract class EventAttend implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\EventAttendTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\EventAttend object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|EventAttend The current object, for fluid interface
     */
     ...
     * @return $this|\EcclesiaCRM\EventAttend The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventAttendTableMap::translateFieldName('AttendId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->attend_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventAttendTableMap::translateFieldName('EventId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->event_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventAttendTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->person_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EventAttendTableMap::translateFieldName('CheckinDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->checkin_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EventAttendTableMap::translateFieldName('CheckinId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkin_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EventAttendTableMap::translateFieldName('CheckoutDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->checkout_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EventAttendTableMap::translateFieldName('CheckoutId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkout_id = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = EventAttendTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\EventAttend'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEventAttendQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getCheckinDate();
                break;
            case 4:
                return $this->getCheckinId();
                break;
            case 5:
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\EventAttend
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\EventAttend The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventAttendTableMap::COL_ATTEND_ID)) {
            $criteria->add(EventAttendTableMap::COL_ATTEND_ID, $this->attend_id);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_EVENT_ID)) {
            $criteria->add(EventAttendTableMap::COL_EVENT_ID, $this->event_id);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_PERSON_ID)) {
            $criteria->add(EventAttendTableMap::COL_PERSON_ID, $this->person_id);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_CHECKIN_DATE)) {
            $criteria->add(EventAttendTableMap::COL_CHECKIN_DATE, $this->checkin_date);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_CHECKIN_ID)) {
            $criteria->add(EventAttendTableMap::COL_CHECKIN_ID, $this->checkin_id);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_CHECKOUT_DATE)) {
            $criteria->add(EventAttendTableMap::COL_CHECKOUT_DATE, $this->checkout_date);
        }
        if ($this->isColumnModified(EventAttendTableMap::COL_CHECKOUT_ID)) {
            $criteria->add(EventAttendTableMap::COL_CHECKOUT_ID, $this->checkout_id);
        }
    ...
    {
        $criteria = ChildEventAttendQuery::create();
        $criteria->add(EventAttendTableMap::COL_ATTEND_ID, $this->attend_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\EventAttend (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\EventAttend Clone of current object.
     * @throws PropelException
     */
