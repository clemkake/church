 ...
 *
 * @method     ChildFamilyQuery leftJoinNoteShare($relationAlias = null) Adds a LEFT JOIN clause to the query using the NoteShare relation
 * @method     ChildFamilyQuery rightJoinNoteShare($relationAlias = null) Adds a RIGHT JOIN clause to the query using the NoteShare relation
 * @method     ChildFamilyQuery innerJoinNoteShare($relationAlias = null) Adds a INNER JOIN clause to the query using the NoteShare relation
 *
 * @method     ChildFamilyQuery joinWithNoteShare($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the NoteShare relation
 *
 * @method     ChildFamilyQuery leftJoinWithNoteShare() Adds a LEFT JOIN clause and with to the query using the NoteShare relation
 * @method     ChildFamilyQuery rightJoinWithNoteShare() Adds a RIGHT JOIN clause and with to the query using the NoteShare relation
 * @method     ChildFamilyQuery innerJoinWithNoteShare() Adds a INNER JOIN clause and with to the query using the NoteShare relation
 *
 * @method     ChildFamilyQuery leftJoinAutoPayment($relationAlias = null) Adds a LEFT JOIN clause to the query using the AutoPayment relation
 * @method     ChildFamilyQuery rightJoinAutoPayment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AutoPayment relation
 * @method     ChildFamilyQuery innerJoinAutoPayment($relationAlias = null) Adds a INNER JOIN clause to the query using the AutoPayment relation
 *
 * @method     ChildFamilyQuery joinWithAutoPayment($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AutoPayment relation
 *
 * @method     ChildFamilyQuery leftJoinWithAutoPayment() Adds a LEFT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildFamilyQuery rightJoinWithAutoPayment() Adds a RIGHT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildFamilyQuery innerJoinWithAutoPayment() Adds a INNER JOIN clause and with to the query using the AutoPayment relation
 *
 * @method     ChildFamilyQuery leftJoinEgive($relationAlias = null) Adds a LEFT JOIN clause to the query using the Egive relation
 * @method     ChildFamilyQuery rightJoinEgive($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Egive relation
 * @method     ChildFamilyQuery innerJoinEgive($relationAlias = null) Adds a INNER JOIN clause to the query using the Egive relation
 *
 * @method     ChildFamilyQuery joinWithEgive($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Egive relation
 *
 * @method     ChildFamilyQuery leftJoinWithEgive() Adds a LEFT JOIN clause and with to the query using the Egive relation
 * @method     ChildFamilyQuery rightJoinWithEgive() Adds a RIGHT JOIN clause and with to the query using the Egive relation
 * @method     ChildFamilyQuery innerJoinWithEgive() Adds a INNER JOIN clause and with to the query using the Egive relation
 *
 ...
 *
 * @method     \EcclesiaCRM\PersonQuery|\EcclesiaCRM\NoteQuery|\EcclesiaCRM\NoteShareQuery|\EcclesiaCRM\AutoPaymentQuery|\EcclesiaCRM\EgiveQuery|\EcclesiaCRM\PledgeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class FamilyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\FamilyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\Family', $modelAlias = null)
    {
     ...
     *
     * @param \EcclesiaCRM\Person|ObjectCollection $person the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByNoteShare($noteShare, $comparison = null)
    {
        if ($noteShare instanceof \EcclesiaCRM\NoteShare) {
            return $this
                ->addUsingAlias(FamilyTableMap::COL_FAM_ID, $noteShare->getShareFamId(), $comparison);
    ...
    public function filterByAutoPayment($autoPayment, $comparison = null)
    {
        if ($autoPayment instanceof \EcclesiaCRM\AutoPayment) {
            return $this
                ->addUsingAlias(FamilyTableMap::COL_FAM_ID, $autoPayment->getFamilyid(), $comparison);
     ...
     * @return $this|ChildFamilyQuery The current query, for fluid interface
     */
    public function joinAutoPayment($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useAutoPaymentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\Egive object
     *
     * @param \EcclesiaCRM\Egive|ObjectCollection $egive the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildFamilyQuery The current query, for fluid interface
     */
    public function filterByEgive($egive, $comparison = null)
    {
        if ($egive instanceof \EcclesiaCRM\Egive) {
            return $this
                ->addUsingAlias(FamilyTableMap::COL_FAM_ID, $egive->getFamId(), $comparison);
        } elseif ($egive instanceof ObjectCollection) {
            return $this
                ->useEgiveQuery()
                ->filterByPrimaryKeys($egive->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByEgive() only accepts arguments of type \EcclesiaCRM\Egive or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Egive relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildFamilyQuery The current query, for fluid interface
     */
    public function joinEgive($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Egive');
    ...
    /**
     * Use the Egive relation Egive object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\EgiveQuery A secondary query class using the current class as primary query
     */
    public function useEgiveQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinEgive($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Egive', '\EcclesiaCRM\EgiveQuery');
    }
