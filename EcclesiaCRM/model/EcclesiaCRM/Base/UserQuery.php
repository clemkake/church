 ...
 * @method     ChildUserQuery orderByHomedir($order = Criteria::ASC) Order by the usr_HomeDir column
 * @method     ChildUserQuery orderByCurrentpath($order = Criteria::ASC) Order by the usr_CurrentPath column
 * @method     ChildUserQuery orderByRoleId($order = Criteria::ASC) Order by the usr_role_id column
 ...
 * @method     ChildUserQuery orderByPastoralCare($order = Criteria::ASC) Order by the usr_PastoralCare column
 * @method     ChildUserQuery orderByMailChimp($order = Criteria::ASC) Order by the usr_MailChimp column
 * @method     ChildUserQuery orderByMainDashboard($order = Criteria::ASC) Order by the usr_MainDashboard column
 * @method     ChildUserQuery orderBySeePrivacyData($order = Criteria::ASC) Order by the usr_SeePrivacyData column
 * @method     ChildUserQuery orderByGdrpDpo($order = Criteria::ASC) Order by the usr_GDRP_DPO column
 ...
 * @method     ChildUserQuery orderByShowMenuQuery($order = Criteria::ASC) Order by the usr_showMenuQuery column
 ...
 * @method     ChildUserQuery orderByWebdavkey($order = Criteria::ASC) Order by the usr_webDavKey column
 ...
 * @method     ChildUserQuery orderByShowCart($order = Criteria::ASC) Order by the usr_ShowCart column
 * @method     ChildUserQuery orderByShowMap($order = Criteria::ASC) Order by the usr_ShowMap column
 *
 * @method     ChildUserQuery groupByPersonId() Group by the usr_per_ID column
 * @method     ChildUserQuery groupByHomedir() Group by the usr_HomeDir column
 * @method     ChildUserQuery groupByCurrentpath() Group by the usr_CurrentPath column
 * @method     ChildUserQuery groupByRoleId() Group by the usr_role_id column
 ...
 * @method     ChildUserQuery groupByPastoralCare() Group by the usr_PastoralCare column
 * @method     ChildUserQuery groupByMailChimp() Group by the usr_MailChimp column
 * @method     ChildUserQuery groupByMainDashboard() Group by the usr_MainDashboard column
 * @method     ChildUserQuery groupBySeePrivacyData() Group by the usr_SeePrivacyData column
 * @method     ChildUserQuery groupByGdrpDpo() Group by the usr_GDRP_DPO column
 ...
 * @method     ChildUserQuery groupByShowMenuQuery() Group by the usr_showMenuQuery column
 ...
 * @method     ChildUserQuery groupByWebdavkey() Group by the usr_webDavKey column
 ...
 * @method     ChildUserQuery groupByShowCart() Group by the usr_ShowCart column
 * @method     ChildUserQuery groupByShowMap() Group by the usr_ShowMap column
 *
 ...
 *
 * @method     \EcclesiaCRM\PersonQuery|\EcclesiaCRM\UserRoleQuery|\EcclesiaCRM\UserConfigQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByHomedir(string $usr_HomeDir) Return the first ChildUser filtered by the usr_HomeDir column
 * @method     ChildUser findOneByCurrentpath(string $usr_CurrentPath) Return the first ChildUser filtered by the usr_CurrentPath column
 * @method     ChildUser findOneByRoleId(int $usr_role_id) Return the first ChildUser filtered by the usr_role_id column
 ...
 * @method     ChildUser findOneByPastoralCare(boolean $usr_PastoralCare) Return the first ChildUser filtered by the usr_PastoralCare column
 * @method     ChildUser findOneByMailChimp(boolean $usr_MailChimp) Return the first ChildUser filtered by the usr_MailChimp column
 * @method     ChildUser findOneByMainDashboard(boolean $usr_MainDashboard) Return the first ChildUser filtered by the usr_MainDashboard column
 * @method     ChildUser findOneBySeePrivacyData(boolean $usr_SeePrivacyData) Return the first ChildUser filtered by the usr_SeePrivacyData column
 * @method     ChildUser findOneByGdrpDpo(boolean $usr_GDRP_DPO) Return the first ChildUser filtered by the usr_GDRP_DPO column
 ...
 * @method     ChildUser findOneByShowMenuQuery(boolean $usr_showMenuQuery) Return the first ChildUser filtered by the usr_showMenuQuery column
 ...
 * @method     ChildUser findOneByWebdavkey(string $usr_webDavKey) Return the first ChildUser filtered by the usr_webDavKey column
 ...
 * @method     ChildUser findOneByShowCart(boolean $usr_ShowCart) Return the first ChildUser filtered by the usr_ShowCart column
 * @method     ChildUser findOneByShowMap(boolean $usr_ShowMap) Return the first ChildUser filtered by the usr_ShowMap column *
 ...
 * @method     ChildUser requireOneByHomedir(string $usr_HomeDir) Return the first ChildUser filtered by the usr_HomeDir column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByCurrentpath(string $usr_CurrentPath) Return the first ChildUser filtered by the usr_CurrentPath column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByRoleId(int $usr_role_id) Return the first ChildUser filtered by the usr_role_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByPastoralCare(boolean $usr_PastoralCare) Return the first ChildUser filtered by the usr_PastoralCare column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByMailChimp(boolean $usr_MailChimp) Return the first ChildUser filtered by the usr_MailChimp column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByMainDashboard(boolean $usr_MainDashboard) Return the first ChildUser filtered by the usr_MainDashboard column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneBySeePrivacyData(boolean $usr_SeePrivacyData) Return the first ChildUser filtered by the usr_SeePrivacyData column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByGdrpDpo(boolean $usr_GDRP_DPO) Return the first ChildUser filtered by the usr_GDRP_DPO column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByShowMenuQuery(boolean $usr_showMenuQuery) Return the first ChildUser filtered by the usr_showMenuQuery column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByWebdavkey(string $usr_webDavKey) Return the first ChildUser filtered by the usr_webDavKey column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByShowCart(boolean $usr_ShowCart) Return the first ChildUser filtered by the usr_ShowCart column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByShowMap(boolean $usr_ShowMap) Return the first ChildUser filtered by the usr_ShowMap column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByHomedir(string $usr_HomeDir) Return ChildUser objects filtered by the usr_HomeDir column
 * @method     ChildUser[]|ObjectCollection findByCurrentpath(string $usr_CurrentPath) Return ChildUser objects filtered by the usr_CurrentPath column
 * @method     ChildUser[]|ObjectCollection findByRoleId(int $usr_role_id) Return ChildUser objects filtered by the usr_role_id column
 ...
 * @method     ChildUser[]|ObjectCollection findByPastoralCare(boolean $usr_PastoralCare) Return ChildUser objects filtered by the usr_PastoralCare column
 * @method     ChildUser[]|ObjectCollection findByMailChimp(boolean $usr_MailChimp) Return ChildUser objects filtered by the usr_MailChimp column
 * @method     ChildUser[]|ObjectCollection findByMainDashboard(boolean $usr_MainDashboard) Return ChildUser objects filtered by the usr_MainDashboard column
 * @method     ChildUser[]|ObjectCollection findBySeePrivacyData(boolean $usr_SeePrivacyData) Return ChildUser objects filtered by the usr_SeePrivacyData column
 * @method     ChildUser[]|ObjectCollection findByGdrpDpo(boolean $usr_GDRP_DPO) Return ChildUser objects filtered by the usr_GDRP_DPO column
 ...
 * @method     ChildUser[]|ObjectCollection findByShowMenuQuery(boolean $usr_showMenuQuery) Return ChildUser objects filtered by the usr_showMenuQuery column
 ...
 * @method     ChildUser[]|ObjectCollection findByWebdavkey(string $usr_webDavKey) Return ChildUser objects filtered by the usr_webDavKey column
 ...
 * @method     ChildUser[]|ObjectCollection findByShowCart(boolean $usr_ShowCart) Return ChildUser objects filtered by the usr_ShowCart column
 * @method     ChildUser[]|ObjectCollection findByShowMap(boolean $usr_ShowMap) Return ChildUser objects filtered by the usr_ShowMap column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\User', $modelAlias = null)
    {
    ...
    /**
     * Filter the query on the usr_HomeDir column
     *
     * Example usage:
     * <code>
     * $query->filterByHomedir('fooValue');   // WHERE usr_HomeDir = 'fooValue'
     * $query->filterByHomedir('%fooValue%', Criteria::LIKE); // WHERE usr_HomeDir LIKE '%fooValue%'
     * </code>
     *
     * @param     string $homedir The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByHomedir($homedir = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($homedir)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(UserTableMap::COL_USR_HOMEDIR, $homedir, $comparison);
    }

    /**
     * Filter the query on the usr_CurrentPath column
     *
     * Example usage:
     * <code>
     * $query->filterByCurrentpath('fooValue');   // WHERE usr_CurrentPath = 'fooValue'
     * $query->filterByCurrentpath('%fooValue%', Criteria::LIKE); // WHERE usr_CurrentPath LIKE '%fooValue%'
     * </code>
     *
     * @param     string $currentpath The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByCurrentpath($currentpath = null, $comparison = null)
    {
        if (null === $comparison) {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USR_CURRENTPATH, $currentpath, $comparison);
    }

    /**
     * Filter the query on the usr_role_id column
     *
     * Example usage:
     * <code>
     * $query->filterByRoleId(1234); // WHERE usr_role_id = 1234
     * $query->filterByRoleId(array(12, 34)); // WHERE usr_role_id IN (12, 34)
     * $query->filterByRoleId(array('min' => 12)); // WHERE usr_role_id > 12
     * </code>
     *
    ...
    public function filterByRoleId($roleId = null, $comparison = null)
    {
        if (is_array($roleId)) {
            $useMinMax = false;
            if (isset($roleId['min'])) {
                $this->addUsingAlias(UserTableMap::COL_USR_ROLE_ID, $roleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($roleId['max'])) {
                $this->addUsingAlias(UserTableMap::COL_USR_ROLE_ID, $roleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_USR_ROLE_ID, $roleId, $comparison);
    }
    ...
    /**
     * Filter the query on the usr_PastoralCare column
     *
     * Example usage:
     * <code>
     * $query->filterByPastoralCare(true); // WHERE usr_PastoralCare = true
     * $query->filterByPastoralCare('yes'); // WHERE usr_PastoralCare = true
     * </code>
     *
     * @param     boolean|string $pastoralCare The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByPastoralCare($pastoralCare = null, $comparison = null)
    {
        if (is_string($pastoralCare)) {
            $pastoralCare = in_array(strtolower($pastoralCare), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_PASTORALCARE, $pastoralCare, $comparison);
    }

    /**
     * Filter the query on the usr_MailChimp column
     *
     * Example usage:
     * <code>
     * $query->filterByMailChimp(true); // WHERE usr_MailChimp = true
     * $query->filterByMailChimp('yes'); // WHERE usr_MailChimp = true
     * </code>
     *
     * @param     boolean|string $mailChimp The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByMailChimp($mailChimp = null, $comparison = null)
    {
        if (is_string($mailChimp)) {
            $mailChimp = in_array(strtolower($mailChimp), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_MAILCHIMP, $mailChimp, $comparison);
    }

    /**
     * Filter the query on the usr_MainDashboard column
     *
     * Example usage:
     * <code>
     * $query->filterByMainDashboard(true); // WHERE usr_MainDashboard = true
     * $query->filterByMainDashboard('yes'); // WHERE usr_MainDashboard = true
     * </code>
     *
     * @param     boolean|string $mainDashboard The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByMainDashboard($mainDashboard = null, $comparison = null)
    {
        if (is_string($mainDashboard)) {
            $mainDashboard = in_array(strtolower($mainDashboard), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_MAINDASHBOARD, $mainDashboard, $comparison);
    }

    /**
     * Filter the query on the usr_SeePrivacyData column
     *
     * Example usage:
     * <code>
     * $query->filterBySeePrivacyData(true); // WHERE usr_SeePrivacyData = true
     * $query->filterBySeePrivacyData('yes'); // WHERE usr_SeePrivacyData = true
     * </code>
     *
     * @param     boolean|string $seePrivacyData The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterBySeePrivacyData($seePrivacyData = null, $comparison = null)
    {
        if (is_string($seePrivacyData)) {
            $seePrivacyData = in_array(strtolower($seePrivacyData), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_SEEPRIVACYDATA, $seePrivacyData, $comparison);
    }

    /**
     * Filter the query on the usr_GDRP_DPO column
     *
     * Example usage:
     * <code>
     * $query->filterByGdrpDpo(true); // WHERE usr_GDRP_DPO = true
     * $query->filterByGdrpDpo('yes'); // WHERE usr_GDRP_DPO = true
     * </code>
     *
     * @param     boolean|string $gdrpDpo The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByGdrpDpo($gdrpDpo = null, $comparison = null)
    {
        if (is_string($gdrpDpo)) {
            $gdrpDpo = in_array(strtolower($gdrpDpo), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_GDRP_DPO, $gdrpDpo, $comparison);
    }
    ...
    /**
     * Filter the query on the usr_showMenuQuery column
     *
     * Example usage:
     * <code>
     * $query->filterByShowMenuQuery(true); // WHERE usr_showMenuQuery = true
     * $query->filterByShowMenuQuery('yes'); // WHERE usr_showMenuQuery = true
     * </code>
     *
     * @param     boolean|string $showMenuQuery The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByShowMenuQuery($showMenuQuery = null, $comparison = null)
    {
        if (is_string($showMenuQuery)) {
            $showMenuQuery = in_array(strtolower($showMenuQuery), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_SHOWMENUQUERY, $showMenuQuery, $comparison);
    }
    ...
    /**
     * Filter the query on the usr_webDavKey column
     *
     * Example usage:
     * <code>
     * $query->filterByWebdavkey('fooValue');   // WHERE usr_webDavKey = 'fooValue'
     * $query->filterByWebdavkey('%fooValue%', Criteria::LIKE); // WHERE usr_webDavKey LIKE '%fooValue%'
     * </code>
     *
     * @param     string $webdavkey The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByWebdavkey($webdavkey = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($webdavkey)) {
                $comparison = Criteria::IN;
            }
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_WEBDAVKEY, $webdavkey, $comparison);
    }
    ...
    /**
     * Filter the query on the usr_ShowCart column
     *
     * Example usage:
     * <code>
     * $query->filterByShowCart(true); // WHERE usr_ShowCart = true
     * $query->filterByShowCart('yes'); // WHERE usr_ShowCart = true
     * </code>
     *
     * @param     boolean|string $showCart The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByShowCart($showCart = null, $comparison = null)
    {
        if (is_string($showCart)) {
            $showCart = in_array(strtolower($showCart), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_SHOWCART, $showCart, $comparison);
    }

    /**
     * Filter the query on the usr_ShowMap column
     *
     * Example usage:
     * <code>
     * $query->filterByShowMap(true); // WHERE usr_ShowMap = true
     * $query->filterByShowMap('yes'); // WHERE usr_ShowMap = true
     * </code>
     *
     * @param     boolean|string $showMap The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByShowMap($showMap = null, $comparison = null)
    {
        if (is_string($showMap)) {
            $showMap = in_array(strtolower($showMap), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(UserTableMap::COL_USR_SHOWMAP, $showMap, $comparison);
    }
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\UserRole object
     *
     * @param \EcclesiaCRM\UserRole|ObjectCollection $userRole The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($userRole instanceof \EcclesiaCRM\UserRole) {
            return $this
                ->addUsingAlias(UserTableMap::COL_USR_ROLE_ID, $userRole->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserTableMap::COL_USR_ROLE_ID, $userRole->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByUserRole() only accepts arguments of type \EcclesiaCRM\UserRole or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\UserRoleQuery A secondary query class using the current class as primary query
     */
    public function useUserRoleQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUserRole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRole', '\EcclesiaCRM\UserRoleQuery');
    }

    /**
     * Filter the query by a related \EcclesiaCRM\UserConfig object
     *
     * @param \EcclesiaCRM\UserConfig|ObjectCollection $userConfig the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    ...
    {
        if ($userConfig instanceof \EcclesiaCRM\UserConfig) {
            return $this
                ->addUsingAlias(UserTableMap::COL_USR_PER_ID, $userConfig->getPersonId(), $comparison);
            ...
            throw new PropelException('filterByUserConfig() only accepts arguments of type \EcclesiaCRM\UserConfig or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\UserConfigQuery A secondary query class using the current class as primary query
     */
    public function useUserConfigQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserConfig($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserConfig', '\EcclesiaCRM\UserConfigQuery');
    }
