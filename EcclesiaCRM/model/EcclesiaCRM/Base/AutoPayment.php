...
abstract class AutoPayment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\AutoPaymentTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\AutoPayment object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\AutoPayment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\AutoPayment'), 0, $e);
        }
    }
    ...
    {
        if ($this->aFamily !== null && $this->aut_famid !== $this->aFamily->getId()) {
            $this->aFamily = null;
        }
        if ($this->aDonationFund !== null && $this->aut_fund !== $this->aDonationFund->getId()) {
            $this->aDonationFund = null;
        }
        if ($this->aPerson !== null && $this->aut_editedby !== $this->aPerson->getId()) {
            $this->aPerson = null;
        }
    } // ensureConsistency
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\AutoPayment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\AutoPayment The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\AutoPayment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\AutoPayment Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aPerson === null && ($this->aut_editedby != 0)) {
            $this->aPerson = ChildPersonQuery::create()->findPk($this->aut_editedby, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addAutoPayments($this);
             */
        }
    ...
    {
        if ($this->aFamily === null && ($this->aut_famid != 0)) {
            $this->aFamily = ChildFamilyQuery::create()->findPk($this->aut_famid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFamily->addAutoPayments($this);
             */
        }
    ...
    {
        if ($this->aDonationFund === null && ($this->aut_fund != 0)) {
            $this->aDonationFund = ChildDonationFundQuery::create()->findPk($this->aut_fund, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDonationFund->addAutoPayments($this);
             */
        }
     ...
     * If this ChildAutoPayment is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAutoPayment The current object (for fluent API support)
     */
    public function setPledges(Collection $pledges, ConnectionInterface $con = null)
    {
        ...
        foreach ($pledgesToDelete as $pledgeRemoved) {
            $pledgeRemoved->setAutoPayment(null);
        }
     ...
     * Otherwise if this AutoPayment is new, it will return
     * an empty collection; or if this AutoPayment has previously
     * been saved, it will retrieve related Pledges from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AutoPayment.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aPerson) {
            $this->aPerson->removeAutoPayment($this);
        }
        if (null !== $this->aFamily) {
            $this->aFamily->removeAutoPayment($this);
        }
        if (null !== $this->aDonationFund) {
            $this->aDonationFund->removeAutoPayment($this);
        }
        $this->aut_id = null;
        $this->aut_famid = null;
