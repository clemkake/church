 ...
 * @method     ChildEventTypesQuery orderByGroupId($order = Criteria::ASC) Order by the type_grpid column
 *
 ...
 * @method     ChildEventTypesQuery groupByGroupId() Group by the type_grpid column
 *
 ...
 *
 * @method     ChildEventTypesQuery leftJoinGroup($relationAlias = null) Adds a LEFT JOIN clause to the query using the Group relation
 * @method     ChildEventTypesQuery rightJoinGroup($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Group relation
 * @method     ChildEventTypesQuery innerJoinGroup($relationAlias = null) Adds a INNER JOIN clause to the query using the Group relation
 *
 * @method     ChildEventTypesQuery joinWithGroup($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Group relation
 *
 * @method     ChildEventTypesQuery leftJoinWithGroup() Adds a LEFT JOIN clause and with to the query using the Group relation
 * @method     ChildEventTypesQuery rightJoinWithGroup() Adds a RIGHT JOIN clause and with to the query using the Group relation
 * @method     ChildEventTypesQuery innerJoinWithGroup() Adds a INNER JOIN clause and with to the query using the Group relation
 *
 * @method     ChildEventTypesQuery leftJoinEventCountName($relationAlias = null) Adds a LEFT JOIN clause to the query using the EventCountName relation
 * @method     ChildEventTypesQuery rightJoinEventCountName($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EventCountName relation
 * @method     ChildEventTypesQuery innerJoinEventCountName($relationAlias = null) Adds a INNER JOIN clause to the query using the EventCountName relation
 *
 * @method     ChildEventTypesQuery joinWithEventCountName($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the EventCountName relation
 *
 * @method     ChildEventTypesQuery leftJoinWithEventCountName() Adds a LEFT JOIN clause and with to the query using the EventCountName relation
 * @method     ChildEventTypesQuery rightJoinWithEventCountName() Adds a RIGHT JOIN clause and with to the query using the EventCountName relation
 * @method     ChildEventTypesQuery innerJoinWithEventCountName() Adds a INNER JOIN clause and with to the query using the EventCountName relation
 *
 * @method     \EcclesiaCRM\GroupQuery|\EcclesiaCRM\EventCountNameQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildEventTypes findOneByGroupId(int $type_grpid) Return the first ChildEventTypes filtered by the type_grpid column *
 ...
 * @method     ChildEventTypes requireOneByGroupId(int $type_grpid) Return the first ChildEventTypes filtered by the type_grpid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildEventTypes[]|ObjectCollection findByGroupId(int $type_grpid) Return ChildEventTypes objects filtered by the type_grpid column
...
abstract class EventTypesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\EventTypesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\EventTypes', $modelAlias = null)
    {
    ...
    public function filterByGroupId($groupId = null, $comparison = null)
    {
        if (is_array($groupId)) {
            ...
            if (isset($groupId['min'])) {
                $this->addUsingAlias(EventTypesTableMap::COL_TYPE_GRPID, $groupId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupId['max'])) {
                $this->addUsingAlias(EventTypesTableMap::COL_TYPE_GRPID, $groupId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventTypesTableMap::COL_TYPE_GRPID, $groupId, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildEventTypesQuery The current query, for fluid interface
     */
    public function filterByGroup($group, $comparison = null)
    {
        if ($group instanceof \EcclesiaCRM\Group) {
            return $this
                ->addUsingAlias(EventTypesTableMap::COL_TYPE_GRPID, $group->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventTypesTableMap::COL_TYPE_GRPID, $group->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\EventCountName object
     *
     * @param \EcclesiaCRM\EventCountName|ObjectCollection $eventCountName the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventTypesQuery The current query, for fluid interface
     */
    public function filterByEventCountName($eventCountName, $comparison = null)
    {
        if ($eventCountName instanceof \EcclesiaCRM\EventCountName) {
            return $this
                ->addUsingAlias(EventTypesTableMap::COL_TYPE_ID, $eventCountName->getTypeId(), $comparison);
        } elseif ($eventCountName instanceof ObjectCollection) {
            return $this
                ->useEventCountNameQuery()
                ->filterByPrimaryKeys($eventCountName->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByEventCountName() only accepts arguments of type \EcclesiaCRM\EventCountName or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the EventCountName relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildEventTypesQuery The current query, for fluid interface
     */
    public function joinEventCountName($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('EventCountName');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'EventCountName');
        }
    ...
    /**
     * Use the EventCountName relation EventCountName object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\EventCountNameQuery A secondary query class using the current class as primary query
     */
    public function useEventCountNameQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinEventCountName($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'EventCountName', '\EcclesiaCRM\EventCountNameQuery');
    }
