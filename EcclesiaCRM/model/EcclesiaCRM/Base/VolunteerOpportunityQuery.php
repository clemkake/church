 ...
 *
 * @method     ChildVolunteerOpportunityQuery leftJoinPersonVolunteerOpportunity($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonVolunteerOpportunity relation
 * @method     ChildVolunteerOpportunityQuery rightJoinPersonVolunteerOpportunity($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonVolunteerOpportunity relation
 * @method     ChildVolunteerOpportunityQuery innerJoinPersonVolunteerOpportunity($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonVolunteerOpportunity relation
 *
 * @method     ChildVolunteerOpportunityQuery joinWithPersonVolunteerOpportunity($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PersonVolunteerOpportunity relation
 *
 * @method     ChildVolunteerOpportunityQuery leftJoinWithPersonVolunteerOpportunity() Adds a LEFT JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 * @method     ChildVolunteerOpportunityQuery rightJoinWithPersonVolunteerOpportunity() Adds a RIGHT JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 * @method     ChildVolunteerOpportunityQuery innerJoinWithPersonVolunteerOpportunity() Adds a INNER JOIN clause and with to the query using the PersonVolunteerOpportunity relation
 *
 * @method     \EcclesiaCRM\PersonVolunteerOpportunityQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class VolunteerOpportunityQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\VolunteerOpportunityQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\VolunteerOpportunity', $modelAlias = null)
    {
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildVolunteerOpportunityQuery The current query, for fluid interface
     */
    public function filterByPersonVolunteerOpportunity($personVolunteerOpportunity, $comparison = null)
    {
        if ($personVolunteerOpportunity instanceof \EcclesiaCRM\PersonVolunteerOpportunity) {
            return $this
                ->addUsingAlias(VolunteerOpportunityTableMap::COL_VOL_ID, $personVolunteerOpportunity->getVolunteerOpportunityId(), $comparison);
