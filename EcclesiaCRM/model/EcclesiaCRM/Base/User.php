...
use EcclesiaCRM\UserConfig as ChildUserConfig;
use EcclesiaCRM\UserConfigQuery as ChildUserConfigQuery;
use EcclesiaCRM\UserQuery as ChildUserQuery;
use EcclesiaCRM\UserRole as ChildUserRole;
use EcclesiaCRM\UserRoleQuery as ChildUserRoleQuery;
use EcclesiaCRM\Map\UserConfigTableMap;
use EcclesiaCRM\Map\UserTableMap;
 ...
 *
 * This contains the login information and specific settings for each EcclesiaCRM user
 *
...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\UserTableMap';
    ...
    /**
     * The value for the usr_homedir field.
     *
     * @var        string
     */
    protected $usr_homedir;

    /**
     * The value for the usr_currentpath field.
     *
     * Note: this column has a database default value of: '/'
     * @var        string
     */
    protected $usr_currentpath;

    /**
     * The value for the usr_role_id field.
     *
     * @var        int
     */
    protected $usr_role_id;
    ...
    /**
     * The value for the usr_pastoralcare field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_pastoralcare;

    /**
     * The value for the usr_mailchimp field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_mailchimp;

    /**
     * The value for the usr_maindashboard field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_maindashboard;

    /**
     * The value for the usr_seeprivacydata field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_seeprivacydata;

    /**
     * The value for the usr_gdrp_dpo field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_gdrp_dpo;
    ...
    /**
     * The value for the usr_showmenuquery field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_showmenuquery;
    ...
    /**
     * The value for the usr_webdavkey field.
     *
     * @var        string
     */
    protected $usr_webdavkey;
    ...
    /**
     * The value for the usr_showcart field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_showcart;

    /**
     * The value for the usr_showmap field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $usr_showmap;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->usr_pastoralcare = false;
        $this->usr_mailchimp = false;
        $this->usr_maindashboard = false;
        $this->usr_seeprivacydata = false;
        $this->usr_gdrp_dpo = false;
        $this->usr_searchlimit = 10;
        $this->usr_style = 'Style.css';
        $this->usr_showpledges = false;
        $this->usr_showpayments = false;
        $this->usr_showmenuquery = false;
        $this->usr_showsince = PropelDateTime::newInstance('2016-01-01', null, 'DateTime');
        $this->usr_defaultfy = 10;
        $this->usr_currentdeposit = 0;
        $this->usr_editself = false;
        $this->usr_canvasser = false;
        $this->usr_showcart = false;
        $this->usr_showmap = false;
    }

    /**
     * Initializes internal state of EcclesiaCRM\Base\User object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [usr_homedir] column value.
     *
     * @return string
     */
    public function getHomedir()
    {
        return $this->usr_homedir;
    }

    /**
     * Get the [usr_currentpath] column value.
     *
     * @return string
     */
    public function getCurrentpath()
    {
        return $this->usr_currentpath;
    }

    /**
     * Get the [usr_role_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [usr_pastoralcare] column value.
     *
     * @return boolean
     */
    public function getPastoralCare()
    {
        return $this->usr_pastoralcare;
    }
     ...
     * @return boolean
     */
    public function isPastoralCare()
    {
        return $this->getPastoralCare();
    }

    /**
     * Get the [usr_mailchimp] column value.
     *
     * @return boolean
     */
    public function getMailChimp()
    {
        return $this->usr_mailchimp;
    }
     ...
     * @return boolean
     */
    public function isMailChimp()
    {
        return $this->getMailChimp();
    }

    /**
     * Get the [usr_maindashboard] column value.
     *
     * @return boolean
     */
    public function getMainDashboard()
    {
        return $this->usr_maindashboard;
    }
     ...
     * @return boolean
     */
    public function isMainDashboard()
    {
        return $this->getMainDashboard();
    }

    /**
     * Get the [usr_seeprivacydata] column value.
     *
     * @return boolean
     */
    public function getSeePrivacyData()
    {
        return $this->usr_seeprivacydata;
    }
     ...
     * @return boolean
     */
    public function isSeePrivacyData()
    {
        return $this->getSeePrivacyData();
    }

    /**
     * Get the [usr_gdrp_dpo] column value.
     *
     * @return boolean
     */
    public function getGdrpDpo()
    {
        return $this->usr_gdrp_dpo;
    }
     ...
     * @return boolean
     */
    public function isGdrpDpo()
    {
        return $this->getGdrpDpo();
    }
    ...
    /**
     * Get the [usr_showmenuquery] column value.
     *
     * @return boolean
     */
    public function getShowMenuQuery()
    {
        return $this->usr_showmenuquery;
    }
     ...
     * @return boolean
     */
    public function isShowMenuQuery()
    {
        return $this->getShowMenuQuery();
    }
    ...
    /**
     * Get the [usr_webdavkey] column value.
     *
     * @return string
     */
    public function getWebdavkey()
    {
        return $this->usr_webdavkey;
    }
     ...
     * @return boolean
     */
    public function isCanvasser()
    {
        return $this->getCanvasser();
    }

    /**
     * Get the [usr_showcart] column value.
     *
     * @return boolean
     */
    public function getShowCart()
    {
        return $this->usr_showcart;
    }
    ...
    {
        return $this->getShowCart();
    }

    /**
     * Get the [usr_showmap] column value.
     *
     * @return boolean
     */
    public function getShowMap()
    {
        return $this->usr_showmap;
    }
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [usr_homedir] column.
     *
    ...
    public function setHomedir($v)
    {
        ...
        if ($this->usr_homedir !== $v) {
            $this->usr_homedir = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_HOMEDIR] = true;
        }
    ...
    /**
     * Set the value of [usr_currentpath] column.
     *
     * @param string $v new value
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setCurrentpath($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->usr_currentpath !== $v) {
            $this->usr_currentpath = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_CURRENTPATH] = true;
        }
    ...
    /**
     * Set the value of [usr_role_id] column.
     *
     * @param int $v new value
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setRoleId($v)
    {
        ...
        if ($this->usr_role_id !== $v) {
            $this->usr_role_id = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_ROLE_ID] = true;
        }
    ...
    /**
     * Sets the value of the [usr_pastoralcare] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setPastoralCare($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->usr_pastoralcare !== $v) {
            $this->usr_pastoralcare = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_PASTORALCARE] = true;
        }
    ...
    /**
     * Sets the value of the [usr_mailchimp] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setMailChimp($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->usr_mailchimp !== $v) {
            $this->usr_mailchimp = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_MAILCHIMP] = true;
        }
    ...
    /**
     * Sets the value of the [usr_maindashboard] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setMainDashboard($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->usr_maindashboard !== $v) {
            $this->usr_maindashboard = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_MAINDASHBOARD] = true;
        }
    ...
    /**
     * Sets the value of the [usr_seeprivacydata] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setSeePrivacyData($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->usr_seeprivacydata !== $v) {
            $this->usr_seeprivacydata = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_SEEPRIVACYDATA] = true;
        }
    ...
    /**
     * Sets the value of the [usr_gdrp_dpo] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setGdrpDpo($v)
    {
        ...
        if ($this->usr_gdrp_dpo !== $v) {
            $this->usr_gdrp_dpo = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_GDRP_DPO] = true;
        }
    ...
    /**
     * Sets the value of the [usr_showmenuquery] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setShowMenuQuery($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->usr_showmenuquery !== $v) {
            $this->usr_showmenuquery = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_SHOWMENUQUERY] = true;
        }
    ...
    /**
     * Set the value of [usr_webdavkey] column.
     *
     * @param string $v new value
     * @return $this|\EcclesiaCRM\User The current object (for fluent API support)
     */
    public function setWebdavkey($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->usr_webdavkey !== $v) {
            $this->usr_webdavkey = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_WEBDAVKEY] = true;
        }
    ...
    /**
     * Sets the value of the [usr_canvasser] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    /**
     * Sets the value of the [usr_showcart] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setShowCart($v)
    {
        ...
        if ($this->usr_showcart !== $v) {
            $this->usr_showcart = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_SHOWCART] = true;
        }
    ...
    /**
     * Sets the value of the [usr_showmap] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setShowMap($v)
    {
        ...
        if ($this->usr_showmap !== $v) {
            $this->usr_showmap = $v;
            $this->modifiedColumns[UserTableMap::COL_USR_SHOWMAP] = true;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->usr_pastoralcare !== false) {
                return false;
            }

            if ($this->usr_mailchimp !== false) {
                return false;
            }

            if ($this->usr_maindashboard !== false) {
                return false;
            }

            if ($this->usr_seeprivacydata !== false) {
                return false;
            }

            if ($this->usr_gdrp_dpo !== false) {
                return false;
            }
            ...
            if ($this->usr_showmenuquery !== false) {
                return false;
            }
            ...
            if ($this->usr_showcart !== false) {
                return false;
            }

            if ($this->usr_showmap !== false) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTableMap::translateFieldName('Homedir', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_homedir = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('Currentpath', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_currentpath = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('RoleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_role_id = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('NeedPasswordChange', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_needpasswordchange = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('LastLogin', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->usr_lastlogin = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('LoginCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_logincount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('FailedLogins', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_failedlogins = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('AddRecords', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_addrecords = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('EditRecords', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_editrecords = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('DeleteRecords', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_deleterecords = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UserTableMap::translateFieldName('MenuOptions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_menuoptions = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UserTableMap::translateFieldName('ManageGroups', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_managegroups = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : UserTableMap::translateFieldName('Finance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_finance = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : UserTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_notes = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : UserTableMap::translateFieldName('Admin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_admin = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : UserTableMap::translateFieldName('PastoralCare', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_pastoralcare = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : UserTableMap::translateFieldName('MailChimp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_mailchimp = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : UserTableMap::translateFieldName('MainDashboard', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_maindashboard = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : UserTableMap::translateFieldName('SeePrivacyData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_seeprivacydata = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : UserTableMap::translateFieldName('GdrpDpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_gdrp_dpo = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : UserTableMap::translateFieldName('SearchLimit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_searchlimit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : UserTableMap::translateFieldName('Style', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_style = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : UserTableMap::translateFieldName('ShowPledges', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showpledges = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : UserTableMap::translateFieldName('ShowPayments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showpayments = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : UserTableMap::translateFieldName('ShowMenuQuery', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showmenuquery = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : UserTableMap::translateFieldName('ShowSince', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_showsince = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : UserTableMap::translateFieldName('DefaultFY', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_defaultfy = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : UserTableMap::translateFieldName('CurrentDeposit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_currentdeposit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : UserTableMap::translateFieldName('UserName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : UserTableMap::translateFieldName('Webdavkey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_webdavkey = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : UserTableMap::translateFieldName('EditSelf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_editself = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : UserTableMap::translateFieldName('CalStart', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calstart = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : UserTableMap::translateFieldName('CalEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calend = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : UserTableMap::translateFieldName('CalNoSchool1', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool1 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : UserTableMap::translateFieldName('CalNoSchool2', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool2 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : UserTableMap::translateFieldName('CalNoSchool3', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool3 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : UserTableMap::translateFieldName('CalNoSchool4', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool4 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : UserTableMap::translateFieldName('CalNoSchool5', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool5 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : UserTableMap::translateFieldName('CalNoSchool6', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool6 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : UserTableMap::translateFieldName('CalNoSchool7', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool7 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : UserTableMap::translateFieldName('CalNoSchool8', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool8 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : UserTableMap::translateFieldName('Searchfamily', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_searchfamily = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : UserTableMap::translateFieldName('Canvasser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_canvasser = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : UserTableMap::translateFieldName('ShowCart', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showcart = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : UserTableMap::translateFieldName('ShowMap', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showmap = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 47; // 47 = UserTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\User'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aUserRole !== null && $this->usr_role_id !== $this->aUserRole->getId()) {
            $this->aUserRole = null;
        }
    } // ensureConsistency
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->userConfigsScheduledForDeletion !== null) {
                if (!$this->userConfigsScheduledForDeletion->isEmpty()) {
                    \EcclesiaCRM\UserConfigQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_HOMEDIR)) {
            $modifiedColumns[':p' . $index++]  = 'usr_HomeDir';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_CURRENTPATH)) {
            $modifiedColumns[':p' . $index++]  = 'usr_CurrentPath';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_ROLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'usr_role_id';
        }
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_PASTORALCARE)) {
            $modifiedColumns[':p' . $index++]  = 'usr_PastoralCare';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_MAILCHIMP)) {
            $modifiedColumns[':p' . $index++]  = 'usr_MailChimp';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_MAINDASHBOARD)) {
            $modifiedColumns[':p' . $index++]  = 'usr_MainDashboard';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SEEPRIVACYDATA)) {
            $modifiedColumns[':p' . $index++]  = 'usr_SeePrivacyData';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_GDRP_DPO)) {
            $modifiedColumns[':p' . $index++]  = 'usr_GDRP_DPO';
        }
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWMENUQUERY)) {
            $modifiedColumns[':p' . $index++]  = 'usr_showMenuQuery';
        }
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_WEBDAVKEY)) {
            $modifiedColumns[':p' . $index++]  = 'usr_webDavKey';
        }
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWCART)) {
            $modifiedColumns[':p' . $index++]  = 'usr_ShowCart';
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWMAP)) {
            $modifiedColumns[':p' . $index++]  = 'usr_ShowMap';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'usr_per_ID':
                        ...
                        break;
                    case 'usr_HomeDir':
                        $stmt->bindValue($identifier, $this->usr_homedir, PDO::PARAM_STR);
                        break;
                    case 'usr_CurrentPath':
                        $stmt->bindValue($identifier, $this->usr_currentpath, PDO::PARAM_STR);
                        break;
                    case 'usr_role_id':
                        $stmt->bindValue($identifier, $this->usr_role_id, PDO::PARAM_INT);
                        break;
                    case 'usr_Password':
                    ...
                    case 'usr_Admin':
                        ...
                        break;
                    case 'usr_PastoralCare':
                        $stmt->bindValue($identifier, (int) $this->usr_pastoralcare, PDO::PARAM_INT);
                        break;
                    case 'usr_MailChimp':
                        $stmt->bindValue($identifier, (int) $this->usr_mailchimp, PDO::PARAM_INT);
                        break;
                    case 'usr_MainDashboard':
                        $stmt->bindValue($identifier, (int) $this->usr_maindashboard, PDO::PARAM_INT);
                        break;
                    case 'usr_SeePrivacyData':
                        $stmt->bindValue($identifier, (int) $this->usr_seeprivacydata, PDO::PARAM_INT);
                        break;
                    case 'usr_GDRP_DPO':
                        $stmt->bindValue($identifier, (int) $this->usr_gdrp_dpo, PDO::PARAM_INT);
                        break;
                    ...
                    case 'usr_showPayments':
                        ...
                        break;
                    case 'usr_showMenuQuery':
                        $stmt->bindValue($identifier, (int) $this->usr_showmenuquery, PDO::PARAM_INT);
                        break;
                    case 'usr_showSince':
                    ...
                    case 'usr_UserName':
                        ...
                        break;
                    case 'usr_webDavKey':
                        $stmt->bindValue($identifier, $this->usr_webdavkey, PDO::PARAM_STR);
                        break;
                    case 'usr_EditSelf':
                    ...
                    case 'usr_SearchFamily':
                        ...
                        break;
                    case 'usr_Canvasser':
                        $stmt->bindValue($identifier, (int) $this->usr_canvasser, PDO::PARAM_INT);
                        break;
                    case 'usr_ShowCart':
                        $stmt->bindValue($identifier, (int) $this->usr_showcart, PDO::PARAM_INT);
                        break;
                    case 'usr_ShowMap':
                        $stmt->bindValue($identifier, (int) $this->usr_showmap, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getHomedir(),
            $keys[2] => $this->getCurrentpath(),
            $keys[3] => $this->getRoleId(),
            $keys[4] => $this->getPassword(),
            $keys[5] => $this->getNeedPasswordChange(),
            $keys[6] => $this->getLastLogin(),
            $keys[7] => $this->getLoginCount(),
            $keys[8] => $this->getFailedLogins(),
            $keys[9] => $this->getAddRecords(),
            $keys[10] => $this->getEditRecords(),
            $keys[11] => $this->getDeleteRecords(),
            $keys[12] => $this->getMenuOptions(),
            $keys[13] => $this->getManageGroups(),
            $keys[14] => $this->getFinance(),
            $keys[15] => $this->getNotes(),
            $keys[16] => $this->getAdmin(),
            $keys[17] => $this->getPastoralCare(),
            $keys[18] => $this->getMailChimp(),
            $keys[19] => $this->getMainDashboard(),
            $keys[20] => $this->getSeePrivacyData(),
            $keys[21] => $this->getGdrpDpo(),
            $keys[22] => $this->getSearchLimit(),
            $keys[23] => $this->getStyle(),
            $keys[24] => $this->getShowPledges(),
            $keys[25] => $this->getShowPayments(),
            $keys[26] => $this->getShowMenuQuery(),
            $keys[27] => $this->getShowSince(),
            $keys[28] => $this->getDefaultFY(),
            $keys[29] => $this->getCurrentDeposit(),
            $keys[30] => $this->getUserName(),
            $keys[31] => $this->getWebdavkey(),
            $keys[32] => $this->getEditSelf(),
            $keys[33] => $this->getCalStart(),
            $keys[34] => $this->getCalEnd(),
            $keys[35] => $this->getCalNoSchool1(),
            $keys[36] => $this->getCalNoSchool2(),
            $keys[37] => $this->getCalNoSchool3(),
            $keys[38] => $this->getCalNoSchool4(),
            $keys[39] => $this->getCalNoSchool5(),
            $keys[40] => $this->getCalNoSchool6(),
            $keys[41] => $this->getCalNoSchool7(),
            $keys[42] => $this->getCalNoSchool8(),
            $keys[43] => $this->getSearchfamily(),
            $keys[44] => $this->getCanvasser(),
            $keys[45] => $this->getShowCart(),
            $keys[46] => $this->getShowMap(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 16:
                ...
                break;
            case 17:
                $this->setPastoralCare($value);
                break;
            case 18:
                $this->setMailChimp($value);
                break;
            case 19:
                $this->setMainDashboard($value);
                break;
            case 20:
                $this->setSeePrivacyData($value);
                break;
            case 21:
                $this->setGdrpDpo($value);
                break;
            case 22:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setHomedir($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCurrentpath($arr[$keys[2]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setNeedPasswordChange($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setLastLogin($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setLoginCount($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setFailedLogins($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setAddRecords($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setEditRecords($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setDeleteRecords($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setMenuOptions($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setManageGroups($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setFinance($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setNotes($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setAdmin($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setPastoralCare($arr[$keys[17]]);
        }
        if (array_key_exists($keys[18], $arr)) {
            $this->setMailChimp($arr[$keys[18]]);
        }
        if (array_key_exists($keys[19], $arr)) {
            $this->setMainDashboard($arr[$keys[19]]);
        }
        if (array_key_exists($keys[20], $arr)) {
            $this->setSeePrivacyData($arr[$keys[20]]);
        }
        if (array_key_exists($keys[21], $arr)) {
            $this->setGdrpDpo($arr[$keys[21]]);
        }
        if (array_key_exists($keys[22], $arr)) {
            $this->setSearchLimit($arr[$keys[22]]);
        }
        if (array_key_exists($keys[23], $arr)) {
            $this->setStyle($arr[$keys[23]]);
        }
        if (array_key_exists($keys[24], $arr)) {
            $this->setShowPledges($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setShowPayments($arr[$keys[25]]);
        }
        if (array_key_exists($keys[26], $arr)) {
            $this->setShowMenuQuery($arr[$keys[26]]);
        }
        if (array_key_exists($keys[27], $arr)) {
            $this->setShowSince($arr[$keys[27]]);
        }
        if (array_key_exists($keys[28], $arr)) {
            $this->setDefaultFY($arr[$keys[28]]);
        }
        if (array_key_exists($keys[29], $arr)) {
            $this->setCurrentDeposit($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setUserName($arr[$keys[30]]);
        }
        if (array_key_exists($keys[31], $arr)) {
            $this->setWebdavkey($arr[$keys[31]]);
        }
        if (array_key_exists($keys[32], $arr)) {
            $this->setEditSelf($arr[$keys[32]]);
        }
        if (array_key_exists($keys[33], $arr)) {
            $this->setCalStart($arr[$keys[33]]);
        }
        if (array_key_exists($keys[34], $arr)) {
            $this->setCalEnd($arr[$keys[34]]);
        }
        if (array_key_exists($keys[35], $arr)) {
            $this->setCalNoSchool1($arr[$keys[35]]);
        }
        if (array_key_exists($keys[36], $arr)) {
            $this->setCalNoSchool2($arr[$keys[36]]);
        }
        if (array_key_exists($keys[37], $arr)) {
            $this->setCalNoSchool3($arr[$keys[37]]);
        }
        if (array_key_exists($keys[38], $arr)) {
            $this->setCalNoSchool4($arr[$keys[38]]);
        }
        if (array_key_exists($keys[39], $arr)) {
            $this->setCalNoSchool5($arr[$keys[39]]);
        }
        if (array_key_exists($keys[40], $arr)) {
            $this->setCalNoSchool6($arr[$keys[40]]);
        }
        if (array_key_exists($keys[41], $arr)) {
            $this->setCalNoSchool7($arr[$keys[41]]);
        }
        if (array_key_exists($keys[42], $arr)) {
            $this->setCalNoSchool8($arr[$keys[42]]);
        }
        if (array_key_exists($keys[43], $arr)) {
            $this->setSearchfamily($arr[$keys[43]]);
        }
        if (array_key_exists($keys[44], $arr)) {
            $this->setCanvasser($arr[$keys[44]]);
        }
        if (array_key_exists($keys[45], $arr)) {
            $this->setShowCart($arr[$keys[45]]);
        }
        if (array_key_exists($keys[46], $arr)) {
            $this->setShowMap($arr[$keys[46]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_HOMEDIR)) {
            $criteria->add(UserTableMap::COL_USR_HOMEDIR, $this->usr_homedir);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_CURRENTPATH)) {
            $criteria->add(UserTableMap::COL_USR_CURRENTPATH, $this->usr_currentpath);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_ROLE_ID)) {
            $criteria->add(UserTableMap::COL_USR_ROLE_ID, $this->usr_role_id);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_PASSWORD)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_PASTORALCARE)) {
            $criteria->add(UserTableMap::COL_USR_PASTORALCARE, $this->usr_pastoralcare);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_MAILCHIMP)) {
            $criteria->add(UserTableMap::COL_USR_MAILCHIMP, $this->usr_mailchimp);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_MAINDASHBOARD)) {
            $criteria->add(UserTableMap::COL_USR_MAINDASHBOARD, $this->usr_maindashboard);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SEEPRIVACYDATA)) {
            $criteria->add(UserTableMap::COL_USR_SEEPRIVACYDATA, $this->usr_seeprivacydata);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_GDRP_DPO)) {
            $criteria->add(UserTableMap::COL_USR_GDRP_DPO, $this->usr_gdrp_dpo);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SEARCHLIMIT)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWMENUQUERY)) {
            $criteria->add(UserTableMap::COL_USR_SHOWMENUQUERY, $this->usr_showmenuquery);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWSINCE)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_WEBDAVKEY)) {
            $criteria->add(UserTableMap::COL_USR_WEBDAVKEY, $this->usr_webdavkey);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_EDITSELF)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWCART)) {
            $criteria->add(UserTableMap::COL_USR_SHOWCART, $this->usr_showcart);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_SHOWMAP)) {
            $criteria->add(UserTableMap::COL_USR_SHOWMAP, $this->usr_showmap);
        }
    ...
    public function hashCode()
    {
        ...
        //relation user_usr_fk_bc9e31 to table person_per
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\User (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setHomedir($this->getHomedir());
        $copyObj->setCurrentpath($this->getCurrentpath());
        ...
        $copyObj->setPastoralCare($this->getPastoralCare());
        $copyObj->setMailChimp($this->getMailChimp());
        $copyObj->setMainDashboard($this->getMainDashboard());
        $copyObj->setSeePrivacyData($this->getSeePrivacyData());
        $copyObj->setGdrpDpo($this->getGdrpDpo());
        ...
        $copyObj->setShowMenuQuery($this->getShowMenuQuery());
        ...
        $copyObj->setWebdavkey($this->getWebdavkey());
        ...
        $copyObj->setShowCart($this->getShowCart());
        $copyObj->setShowMap($this->getShowMap());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\User Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aPerson === null && ($this->usr_per_id != 0)) {
    ...
    {
        if ($this->aUserRole === null && ($this->usr_role_id != 0)) {
            $this->aUserRole = ChildUserRoleQuery::create()->findPk($this->usr_role_id, $con);
    ...
    public function initUserConfigs($overrideExisting = true)
    {
        ...
        $this->collUserConfigs->setModel('\EcclesiaCRM\UserConfig');
    }
    ...
    {
        if (null !== $this->aPerson) {
            $this->aPerson->removeUser($this);
        }
        if (null !== $this->aUserRole) {
            $this->aUserRole->removeUser($this);
        }
        $this->usr_per_id = null;
        $this->usr_homedir = null;
        $this->usr_currentpath = null;
        $this->usr_role_id = null;
        ...
        $this->usr_notes = null;
        $this->usr_admin = null;
        $this->usr_pastoralcare = null;
        $this->usr_mailchimp = null;
        $this->usr_maindashboard = null;
        $this->usr_seeprivacydata = null;
        $this->usr_gdrp_dpo = null;
        $this->usr_searchlimit = null;
        $this->usr_style = null;
        $this->usr_showpledges = null;
        $this->usr_showpayments = null;
        $this->usr_showmenuquery = null;
        $this->usr_showsince = null;
        $this->usr_defaultfy = null;
        $this->usr_currentdeposit = null;
        $this->usr_username = null;
        $this->usr_webdavkey = null;
        ...
        $this->usr_showcart = null;
        $this->usr_showmap = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
        $this->resetModified();
