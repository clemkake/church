 ...
 *
 * @method     ChildAutoPaymentQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildAutoPaymentQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildAutoPaymentQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     ChildAutoPaymentQuery joinWithPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Person relation
 *
 * @method     ChildAutoPaymentQuery leftJoinWithPerson() Adds a LEFT JOIN clause and with to the query using the Person relation
 * @method     ChildAutoPaymentQuery rightJoinWithPerson() Adds a RIGHT JOIN clause and with to the query using the Person relation
 * @method     ChildAutoPaymentQuery innerJoinWithPerson() Adds a INNER JOIN clause and with to the query using the Person relation
 *
 * @method     ChildAutoPaymentQuery leftJoinFamily($relationAlias = null) Adds a LEFT JOIN clause to the query using the Family relation
 * @method     ChildAutoPaymentQuery rightJoinFamily($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Family relation
 * @method     ChildAutoPaymentQuery innerJoinFamily($relationAlias = null) Adds a INNER JOIN clause to the query using the Family relation
 *
 * @method     ChildAutoPaymentQuery joinWithFamily($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Family relation
 *
 * @method     ChildAutoPaymentQuery leftJoinWithFamily() Adds a LEFT JOIN clause and with to the query using the Family relation
 * @method     ChildAutoPaymentQuery rightJoinWithFamily() Adds a RIGHT JOIN clause and with to the query using the Family relation
 * @method     ChildAutoPaymentQuery innerJoinWithFamily() Adds a INNER JOIN clause and with to the query using the Family relation
 *
 * @method     ChildAutoPaymentQuery leftJoinDonationFund($relationAlias = null) Adds a LEFT JOIN clause to the query using the DonationFund relation
 * @method     ChildAutoPaymentQuery rightJoinDonationFund($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DonationFund relation
 * @method     ChildAutoPaymentQuery innerJoinDonationFund($relationAlias = null) Adds a INNER JOIN clause to the query using the DonationFund relation
 *
 * @method     ChildAutoPaymentQuery joinWithDonationFund($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the DonationFund relation
 *
 * @method     ChildAutoPaymentQuery leftJoinWithDonationFund() Adds a LEFT JOIN clause and with to the query using the DonationFund relation
 * @method     ChildAutoPaymentQuery rightJoinWithDonationFund() Adds a RIGHT JOIN clause and with to the query using the DonationFund relation
 * @method     ChildAutoPaymentQuery innerJoinWithDonationFund() Adds a INNER JOIN clause and with to the query using the DonationFund relation
 *
 * @method     ChildAutoPaymentQuery leftJoinPledge($relationAlias = null) Adds a LEFT JOIN clause to the query using the Pledge relation
 * @method     ChildAutoPaymentQuery rightJoinPledge($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Pledge relation
 * @method     ChildAutoPaymentQuery innerJoinPledge($relationAlias = null) Adds a INNER JOIN clause to the query using the Pledge relation
 *
 * @method     ChildAutoPaymentQuery joinWithPledge($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Pledge relation
 *
 * @method     ChildAutoPaymentQuery leftJoinWithPledge() Adds a LEFT JOIN clause and with to the query using the Pledge relation
 * @method     ChildAutoPaymentQuery rightJoinWithPledge() Adds a RIGHT JOIN clause and with to the query using the Pledge relation
 * @method     ChildAutoPaymentQuery innerJoinWithPledge() Adds a INNER JOIN clause and with to the query using the Pledge relation
 *
 * @method     \EcclesiaCRM\PersonQuery|\EcclesiaCRM\FamilyQuery|\EcclesiaCRM\DonationFundQuery|\EcclesiaCRM\PledgeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AutoPaymentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\AutoPaymentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\AutoPayment', $modelAlias = null)
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildAutoPaymentQuery The current query, for fluid interface
     */
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \EcclesiaCRM\Person) {
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_EDITEDBY, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_EDITEDBY, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByFamily($family, $comparison = null)
    {
        if ($family instanceof \EcclesiaCRM\Family) {
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_FAMID, $family->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_FAMID, $family->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\DonationFund object
     *
     * @param \EcclesiaCRM\DonationFund|ObjectCollection $donationFund The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($donationFund instanceof \EcclesiaCRM\DonationFund) {
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_FUND, $donationFund->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_FUND, $donationFund->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByDonationFund() only accepts arguments of type \EcclesiaCRM\DonationFund or Collection');
        }
    }
     ...
     * @return $this|ChildAutoPaymentQuery The current query, for fluid interface
     */
    public function joinDonationFund($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\DonationFundQuery A secondary query class using the current class as primary query
     */
    public function useDonationFundQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinDonationFund($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'DonationFund', '\EcclesiaCRM\DonationFundQuery');
    }
    ...
    public function filterByPledge($pledge, $comparison = null)
    {
        if ($pledge instanceof \EcclesiaCRM\Pledge) {
            return $this
                ->addUsingAlias(AutoPaymentTableMap::COL_AUT_ID, $pledge->getAutId(), $comparison);
