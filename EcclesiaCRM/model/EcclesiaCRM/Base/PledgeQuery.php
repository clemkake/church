 ...
 *
 * @method     ChildPledgeQuery leftJoinAutoPayment($relationAlias = null) Adds a LEFT JOIN clause to the query using the AutoPayment relation
 * @method     ChildPledgeQuery rightJoinAutoPayment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AutoPayment relation
 * @method     ChildPledgeQuery innerJoinAutoPayment($relationAlias = null) Adds a INNER JOIN clause to the query using the AutoPayment relation
 *
 * @method     ChildPledgeQuery joinWithAutoPayment($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AutoPayment relation
 *
 * @method     ChildPledgeQuery leftJoinWithAutoPayment() Adds a LEFT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildPledgeQuery rightJoinWithAutoPayment() Adds a RIGHT JOIN clause and with to the query using the AutoPayment relation
 * @method     ChildPledgeQuery innerJoinWithAutoPayment() Adds a INNER JOIN clause and with to the query using the AutoPayment relation
 *
 ...
 *
 * @method     \EcclesiaCRM\DepositQuery|\EcclesiaCRM\DonationFundQuery|\EcclesiaCRM\FamilyQuery|\EcclesiaCRM\AutoPaymentQuery|\EcclesiaCRM\PersonQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PledgeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\PledgeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\Pledge', $modelAlias = null)
    {
     ...
     *
     * @param \EcclesiaCRM\Deposit|ObjectCollection $deposit The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \EcclesiaCRM\AutoPayment|ObjectCollection $autoPayment The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByAutoPayment($autoPayment, $comparison = null)
    {
        if ($autoPayment instanceof \EcclesiaCRM\AutoPayment) {
            return $this
                ->addUsingAlias(PledgeTableMap::COL_PLG_AUT_ID, $autoPayment->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PledgeTableMap::COL_PLG_AUT_ID, $autoPayment->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
